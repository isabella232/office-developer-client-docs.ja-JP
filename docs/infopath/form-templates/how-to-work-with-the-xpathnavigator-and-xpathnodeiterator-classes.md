...
> [!TIP]
> <span data-ttu-id="12c13-110">[!ヒント] スクリプトから MSXML5 を使用して Microsoft InfoPath 2003 のデータを操作する方法に慣れている場合は、 **CreateNavigator** メソッドを **DataObject** の **DOM** プロパティに代わるものと考えることができます。</span><span class="sxs-lookup"><span data-stu-id="12c13-110">If you are familiar with using MSXML5 from script to work with data in Microsoft InfoPath 2003, you can think of the **CreateNavigator** method as the replacement for the **DOM** property of the **DataObject**.</span></span> 
