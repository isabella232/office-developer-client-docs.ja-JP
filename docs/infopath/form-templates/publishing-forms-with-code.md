...
|**発行** <br/> |InfoPath から直接発行できます。  <br/> |サーバーの全体管理または stsadm コマンドライン ツールを使用して展開できます。  <br/> |
...
- プログラミング言語として C# または Visual Basic を使用する必要があります。
    
- 電子メール データ接続に送信できません。
    
- パーツからパーツへの接続の場合、プロパティを昇格させることはできません。
