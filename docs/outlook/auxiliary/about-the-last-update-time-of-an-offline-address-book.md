...
---
# <a name="about-the-last-update-time-of-an-offline-address-book"></a><span data-ttu-id="3fbb3-103">オフライン アドレス帳の最終更新時刻について</span><span class="sxs-lookup"><span data-stu-id="3fbb3-103">About the last update time of an Offline Address Book</span></span>
