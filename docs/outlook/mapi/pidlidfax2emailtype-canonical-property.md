...
ms.locfileid: "32331767"
---
# <a name="pidlidfax2emailtype-canonical-property"></a>PidLidFax2EmailType 標準プロパティ

  
  
**適用対象**: Outlook 2013 | Outlook 2016 
  
連絡先の自宅の fax アドレスの電子メールの種類を指定します。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidFax2EmailType  <br/> |
|プロパティセット:  <br/> |PSETID_Address  <br/> |
|ロング ID (LID):  <br/> |0x000080c7  <br/> |
