---
title: PidNameContentTransferEncoding 標準プロパティ
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "32356323"
---
# <a name="pidnamecontenttransferencoding-canonical-property"></a>PidNameContentTransferEncoding 標準プロパティ

  
  
**適用対象**: Outlook 2013 | Outlook 2016 
  
[RFC3282] コンテンツ転送エンコードヘッダーフィールド値が含まれています。
  
|||
|:-----|:-----|
|フレンドリ名:  <br/> |なし  <br/> |
|プロパティセット:  <br/> |PS_INTERNET_HEADERS  <br/> |
|プロパティ名:  <br/> |Content-Transfer-Encoding  <br/> |
