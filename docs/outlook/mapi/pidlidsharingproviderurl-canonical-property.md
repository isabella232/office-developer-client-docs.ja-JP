...
共有プロバイダーに関連し、 **dispidsharingproviderguid** ([PidLidSharingProviderGuid](pidlidsharingproviderguid-canonical-property.md)) プロパティで識別される URL を指定します。 これは、共有メッセージのプロパティです。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidSharingProviderUrl  <br/> |
|プロパティセット:  <br/> |PSETID_Sharing  <br/> |
|ロング ID (LID):  <br/> |0x00008A03  <br/> |
|データの種類 :   <br/> |PT_UNICODE  <br/> |
|エリア:  <br/> |共有  <br/> |
   
## <a name="remarks"></a>解説

このプロパティは、通常、共有プロバイダーに関する詳細情報を提供するために使用されますが、無視する必要があります。
