...
共有プロバイダーに関連付け **、dispidSharingProviderGuid** ([PidLidSharingProviderGuid](pidlidsharingproviderguid-canonical-property.md)) プロパティによって識別される URL を指定します。 これは、共有メッセージのプロパティです。
...
このプロパティは、通常、共有プロバイダーに関する詳細を提供するために使用されますが、無視する必要があります。
