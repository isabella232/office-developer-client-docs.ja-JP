---
title: PidNamePageCount の標準的なプロパティ
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "19802345"
---
# <a name="pidnamepagecount-canonical-property"></a>PidNamePageCount の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
ドキュメントに添付ファイルのページ数を指定します。
  
|||
|:-----|:-----|
|フレンドリ名:  <br/> |なし  <br/> |
|プロパティを設定します。  <br/> |PS_PUBLIC_STRINGS  <br/> |
|プロパティ名:  <br/> |PageCount  <br/> |
