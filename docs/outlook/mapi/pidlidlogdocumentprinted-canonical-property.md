...
---
# <a name="pidlidlogdocumentprinted-canonical-property"></a>PidLidLogDocumentPrinted 標準プロパティ

  
  
**適用対象**: Outlook 2013 | Outlook 2016 
  
ジャーナル処理中にドキュメントが印刷されたかどうかを示します。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidlogdocprinted 印刷  <br/> |
|プロパティセット:  <br/> |PSETID_Log  <br/> |
|ロング ID (LID):  <br/> |0x0000870e  <br/> |
