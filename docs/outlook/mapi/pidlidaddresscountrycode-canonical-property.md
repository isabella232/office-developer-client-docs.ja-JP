---
title: PidLidAddressCountryCode の標準的なプロパティ
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidlidaddresscountrycode-canonical-property"></a>PidLidAddressCountryCode の標準的なプロパティ
...
|||
|:-----|:-----|
|関連するプロパティ。  <br/> |dispidAddressCountryCode  <br/> |
|プロパティを設定します。  <br/> |PSETID_Address  <br/> |
|長い ID (LID):  <br/> |0x000080DD  <br/> |
