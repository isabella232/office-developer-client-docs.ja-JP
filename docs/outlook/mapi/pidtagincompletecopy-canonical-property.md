...
---
# <a name="pidtagincompletecopy-canonical-property"></a>PidTagIncompleteCopy 標準プロパティ

  
  
**適用対象**: Outlook 
  
このメッセージが別のメッセージの不完全なコピーである場合、TRUE が格納されます。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |PR_INCOMPLETE_COPY  <br/> |
|識別子:  <br/> |0x0035  <br/> |
|データの種類 :   <br/> |PT_BOOLEAN  <br/> |
|領域:  <br/> |メッセージのプロパティの [全般]  <br/> |
