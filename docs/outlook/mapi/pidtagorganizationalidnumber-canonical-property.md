---
title: PidTagOrganizationalIdNumber の標準的なプロパティ
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidtagorganizationalidnumber-canonical-property"></a>PidTagOrganizationalIdNumber の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
従業員 ID 番号など、連絡先の組織の ID 番号が含まれています。
...
以下は、省略可能なプロパティです。 使用は、メッセージングのユーザーまたは組織によって決定されます。
