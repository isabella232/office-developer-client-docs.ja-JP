...
カレンダー オブジェクトを一度設定するには、このプロパティの値を変更しないでください。 形式の詳細については、 [[MS OXOCAL]](https://msdn.microsoft.com/library/9b636532-9150-4836-9635-9c9b756c9ccf%28Office.15%29.aspx)を参照しています。
