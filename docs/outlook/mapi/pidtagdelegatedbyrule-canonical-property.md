...
ms.locfileid: "59613535"
---
# <a name="pidtagdelegatedbyrule-canonical-property"></a>PidTagDelegatedByRule 標準プロパティ

  
  
**適用対象**: Outlook 2013 | Outlook 2016 
  
フォルダーのメッセージがルールによって委任されるかどうかを示します。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |PR_DELEGATED_BY_RULE  <br/> |
|識別子:  <br/> |0x3FE3  <br/> |
