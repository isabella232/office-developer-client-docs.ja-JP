...
存在する場合、このプロパティは、次の表で、または[[MS OXOCNTC]](https://msdn.microsoft.com/library/9b636532-9150-4836-9635-9c9b756c9ccf%28Office.15%29.aspx)で指定されている値のいずれかで必要があります。 表示しない場合は、設定、アプリケーションを想定してください値が"0x00000000"であります。
