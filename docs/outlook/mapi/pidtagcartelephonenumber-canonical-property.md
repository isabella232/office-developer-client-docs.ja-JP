...
---
# <a name="pidtagcartelephonenumber-canonical-property"></a>PidTagCarTelephoneNumber 標準プロパティ
...
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |PR_CAR_TELEPHONE_NUMBER、PR_CAR_TELEPHONE_NUMBER_A、PR_CAR_TELEPHONE_NUMBER_W  <br/> |
|識別子:  <br/> |0x3a1e  <br/> |
...
これらのプロパティは、受信者に関する id とアクセス情報を提供します。 受信者と受信者の組織によって定義されます。 
