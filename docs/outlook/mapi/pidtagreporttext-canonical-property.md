...
メッセージングシステムによって生成されるレポートのオプションのテキストが含まれています。
...
通常、これらのプロパティに含まれるテキストは、配信レポートまたは配信不能レポート、または基になるメッセージングシステムから受信した読み取りまたは非開封レポートに対して生成されますが、そのシステムを介して転送されたテキストではありません。 
