...
---
# <a name="pidlidremindertime-canonical-property"></a>PidLidReminderTime の標準的なプロパティ
...
|||
|:-----|:-----|
|関連するプロパティ。  <br/> |dispidReminderTime  <br/> |
|プロパティを設定します。  <br/> |PSETID_Common  <br/> |
|長い ID (LID):  <br/> |0x00008502  <br/> |
|データを入力します。  <br/> |PT_SYSTIME  <br/> |
|領域:  <br/> |アラーム  <br/> |
   
## <a name="remarks"></a>備考

カレンダー オブジェクトは、このプロパティは、予定の開始時刻である場合、あるユーザーは、遅延時間で表します。 クライアントは、世界協定時刻 (UTC) で値を設定する必要があります。
