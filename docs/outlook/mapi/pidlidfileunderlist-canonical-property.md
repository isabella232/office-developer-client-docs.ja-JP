...
**dispidfile過小 id** ([PidLidFileUnderId](pidlidfileunderid-canonical-property.md)) プロパティに使用可能な値のリストを指定します。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidfile過小一覧  <br/> |
|プロパティセット:  <br/> |PSETID_Address  <br/> |
|ロング ID (LID):  <br/> |0x00008026  <br/> |
|データの種類 :   <br/> |PT_MV_LONG  <br/> |
|エリア:  <br/> |連絡先  <br/> |
   
## <a name="remarks"></a>解説

複数値プロパティの各値は、 [[OXOCNTC]](https://msdn.microsoft.com/library/9b636532-9150-4836-9635-9c9b756c9ccf%28Office.15%29.aspx)で指定された**dispidfile過小 id**に対して許可された値のいずれかである必要があります。
