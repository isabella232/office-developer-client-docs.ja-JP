...
---
# <a name="pidlidcontactuserfield2-canonical-property"></a>PidLidContactUserField2 標準プロパティ

  
  
**適用対象**: Outlook 2013 | Outlook 2016 
  
連絡先のその他の使用を目的とする連絡先の2番目のフィールドを指定します。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidContactUserField2  <br/> |
|プロパティセット:  <br/> |PSETID_Address  <br/> |
|ロング ID (LID):  <br/> |0x00008050  <br/> |
