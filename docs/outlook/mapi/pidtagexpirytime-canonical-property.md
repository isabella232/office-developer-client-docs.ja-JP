...
---
# <a name="pidtagexpirytime-canonical-property"></a>PidTagExpiryTime の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
日付と時刻のメッセージング システムがメッセージの内容を無効にするとが含まれています。 
...
処理でメッセージング システムに配信された個人間のメッセージを送信するこのプロパティを使用します。 
