---
title: PidTagRadioTelephoneNumber の標準的なプロパティ
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidtagradiotelephonenumber-canonical-property"></a>PidTagRadioTelephoneNumber の標準的なプロパティ
...
|||
|:-----|:-----|
|関連するプロパティ。  <br/> |PR_RADIO_TELEPHONE_NUMBER、PR_RADIO_TELEPHONE_NUMBER_A、PR_RADIO_TELEPHONE_NUMBER_W  <br/> |
|識別子:  <br/> |0x3A1D  <br/> |
