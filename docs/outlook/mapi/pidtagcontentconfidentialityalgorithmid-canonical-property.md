...
---
# <a name="pidtagcontentconfidentialityalgorithmid-canonical-property"></a>PidTagContentConfidentialityAlgorithmId の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
メッセージ コンテンツの秘密性を確認するためのアルゴリズムの識別子が含まれています。
  
|||
|:-----|:-----|
|関連するプロパティ。  <br/> |PR_CONTENT_CONFIDENTIALITY_ALGORITHM_ID  <br/> |
|識別子:  <br/> |0x0006  <br/> |
