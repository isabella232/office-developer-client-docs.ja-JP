...
送信メールに設定する必要がある添付ファイルのエンコード方法と HTML のインクルードを示します。
...
このプロパティが分割されるサブの部分については、 [[OXOMSG]](https://msdn.microsoft.com/library/daa9120f-f325-4afb-a738-28f91049ab3c%28Office.15%29.aspx)を参照してください。 
