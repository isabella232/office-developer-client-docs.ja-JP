...
ルールに関連付けられているアクションのセットが含まれています。 
...
アクションはルールの処理として表現され、プロパティ値バッファーには、 [[OXORULE]](https://msdn.microsoft.com/library/70ac9436-501e-43e2-9163-20d2b546b886%28Office.15%29.aspx)で指定されたとおりにパッケージ化されたルールアクションデータバッファー構造が含まれます。
...
|**ファイル**|**関数**|**コメント**|
|:-----|:-----|:-----|
|importprocs  <br/> |propcopymore、hrcopyactions  <br/> |これらの関数は、別のプロパティにコピーする目的で PT_ACTIONS プロパティを解析する方法を示しています。  <br/> |
