...
## <a name="see-also"></a><span data-ttu-id="d5b17-110">関連項目</span><span class="sxs-lookup"><span data-stu-id="d5b17-110">See also</span></span>

- [<span data-ttu-id="d5b17-111">MAPI プログラミングの概要</span><span class="sxs-lookup"><span data-stu-id="d5b17-111">MAPI Programming Overview</span></span>](mapi-programming-overview.md)
