...
このプロパティが存在し、TRUE に設定されている場合、連絡先の添付ファイル テーブルには **、PR_ATTACHMENT_CONTACTPHOTO** ([PidTagAttachmentContactPhoto](pidtagattachmentcontactphoto-canonical-property.md)) プロパティが TRUE に設定された添付ファイルが含まれる。
