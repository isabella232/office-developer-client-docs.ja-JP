...
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispid会議の種類  <br/> |
|プロパティセット:  <br/> |PSETID_Meeting  <br/> |
|ロング ID (LID):  <br/> |0x00000026  <br/> |
...
|**プロパティ**|**値**|**説明**|
|:-----|:-----|:-----|
|mtgempty  <br/> |0x00000000  <br/> |予測.  <br/> |
|mtgRequest  <br/> |0x00000001  <br/> |最初の会議出席依頼。  <br/> |
|mtgfull  <br/> |0x00010000  <br/> |完全更新。  <br/> |
|mtginfo  <br/> |0x00020000  <br/> |情報更新。  <br/> |
|mtgOutOfDate  <br/> |0x00080000  <br/> |この後に新しい会議出席依頼または会議の更新が受信されました。  <br/> |
|mtgDelegatorCopy  <br/> |0x00100000  <br/> |これは、代理人が会議関連オブジェクトを処理するときに、委任者のコピーに対して設定されます。  <br/> |
