---
title: PidTagWeddingAnniversary の標準的なプロパティ
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidtagweddinganniversary-canonical-property"></a>PidTagWeddingAnniversary の標準的なプロパティ
...
|||
|:-----|:-----|
|関連するプロパティ。  <br/> |PR_WEDDING_ANNIVERSARY  <br/> |
|識別子:  <br/> |0x3A41  <br/> |
...
このプロパティは、ユーザーまたはユーザーの組織によって定義されます。
