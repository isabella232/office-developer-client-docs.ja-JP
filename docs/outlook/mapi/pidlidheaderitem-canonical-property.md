...
かどうか Outlook のダウンロードがクライアント コンピューターに、メッセージまたはヘッダーとメッセージの本文のヘッダーのみ Exchange キャッシュ モードで Outlook が構成されている場合を指定します。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidHeaderItem  <br/> |
|プロパティを設定します。  <br/> |PSETID_Common  <br/> |
|長い ID (LID):  <br/> |0x00008578  <br/> |
