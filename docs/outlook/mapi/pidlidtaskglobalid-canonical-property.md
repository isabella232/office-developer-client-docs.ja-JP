...
---
# <a name="pidlidtaskglobalid-canonical-property"></a>PidLidTaskGlobalId の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
タスクの応答またはタスクの更新の受信時に、GUID を使用して、既存のタスクを検索します。
...
このプロパティは、割り当てられていないタスクの設定を解除に残されています。
