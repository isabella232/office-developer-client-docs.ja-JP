...
定期的なタスクに関する情報を提供する RecurrencePattern 構造が含まれています。
...
RecurrencePattern 構造を作成して指定する方法の詳細については、「Create a Simple Recurrent Task Item 」 [を参照してください](how-to-create-a-simple-recurrent-task-item.md)。
