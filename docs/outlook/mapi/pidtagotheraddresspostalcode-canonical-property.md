---
title: PidTagOtherAddressPostalCode の標準的なプロパティ
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "19803136"
---
# <a name="pidtagotheraddresspostalcode-canonical-property"></a>PidTagOtherAddressPostalCode の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
その他の郵便の宛先ユーザーのにはメールの郵便番号コードが含まれています。
