---
title: PidNameXSharingProviderGuid の標準的なプロパティ
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidnamexsharingproviderguid-canonical-property"></a>PidNameXSharingProviderGuid の標準的なプロパティ
...
|プロパティ名:  <br/> |X-共有-プロバイダーの Guid  <br/> |
