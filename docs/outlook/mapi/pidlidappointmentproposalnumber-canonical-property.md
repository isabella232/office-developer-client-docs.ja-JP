...
---
# <a name="pidlidappointmentproposalnumber-canonical-property"></a>PidLidAppointmentProposalNumber の標準的なプロパティ
...
|||
|:-----|:-----|
|関連するプロパティ。  <br/> |dispidApptProposalNum  <br/> |
|プロパティを設定します。  <br/> |PSETID_Appointment  <br/> |
|長い ID (LID):  <br/> |0x00008259  <br/> |
