...
---
# <a name="pidtagphysicaldeliverybureaufaxdelivery-canonical-property"></a>PidTagPhysicalDeliveryBureauFaxDelivery の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
TRUE が含まれる場合、メッセージング システムはこのメッセージの物理的な配信のため、fax の事務所を使用する必要があります。
