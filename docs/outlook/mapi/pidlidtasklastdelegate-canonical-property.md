...
**適用対象**: Outlook 2013 | Outlook 2016 
 ...
 最近割り当てられたユーザー、またはタスクが割り当てられたユーザーの名前を指定します。 
...
タスク要求を送信する前に、クライアントはタスク割り当て者の名前にこのプロパティを設定します。 タスク応答を送信する前に、クライアントはタスクの割り当て先の名前にこのプロパティを設定します。
