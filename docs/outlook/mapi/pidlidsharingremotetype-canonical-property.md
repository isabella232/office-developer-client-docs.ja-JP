...
このプロパティは **、dispidSharingLocalType** ([PidLidSharingLocalType)](pidlidsharinglocaltype-canonical-property.md)プロパティと同じ値に設定する必要があります。無視する必要があります。
