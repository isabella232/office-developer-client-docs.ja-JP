...
---
# <a name="pidtaggivenname-canonical-property"></a>PidTagGivenName 標準プロパティ

  
  
**適用対象**: Outlook 2013 | Outlook 2016 
  
受信者の最初または特定の名前が含まれます。 
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |PR_GIVEN_NAME、PR_GIVEN_NAME_A、PR_GIVEN_NAME_W  <br/> |
|識別子:  <br/> |0x3A06  <br/> |
...
これらのプロパティは、受信者に関する id とアクセス情報を提供します。 受信者と組織で定義されています。 
