...
---
# <a name="pidtagnondeliveryreportfromsearchkey-canonical-property"></a>PidTagNonDeliveryReportFromSearchKey 標準プロパティ

  
  
**適用対象**: Outlook 
  
場合は、配信不能レポートの設定、失敗した送信の検索キーを示します-ユーザーとしてします。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |PR_NDR_FROM_SEARCH_KEY  <br/> |
|識別子:  <br/> |0x6906  <br/> |
