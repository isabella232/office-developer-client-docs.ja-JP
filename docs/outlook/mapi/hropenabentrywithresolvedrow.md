...
解決された行から **emsabpUID** を自動的に取得し **、entryID** を開く以外は [、HrOpenABEntryWithExchangeContext](hropenabentrywithexchangecontext.md)と同じ関数を実行します。
...
> [in] **emsabpUID** を取得し **、entryID** を開くのに使用される解決済み行へのポインター。
