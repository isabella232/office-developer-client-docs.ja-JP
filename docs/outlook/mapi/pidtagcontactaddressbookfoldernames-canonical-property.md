...
---
# <a name="pidtagcontactaddressbookfoldernames-canonical-property"></a>PidTagContactAddressBookFolderNames の標準的なプロパティ
...
|||
|:-----|:-----|
|関連するプロパティ。  <br/> |PR_CONTAB_FOLDER_NAMES  <br/> |
|識別子:  <br/> |0x6623  <br/> |
...
これらは、アドレス帳の連絡先のプロファイル セクションのプロパティです。
