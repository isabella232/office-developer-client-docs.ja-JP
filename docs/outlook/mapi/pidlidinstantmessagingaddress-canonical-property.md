...
---
# <a name="pidlidinstantmessagingaddress-canonical-property"></a>PidLidInstantMessagingAddress の標準的なプロパティ
...
|||
|:-----|:-----|
|関連するプロパティ。  <br/> |dispidInstMsg  <br/> |
|プロパティを設定します。  <br/> |PSETID_Address  <br/> |
|長い ID (LID):  <br/> |0x00008062  <br/> |
