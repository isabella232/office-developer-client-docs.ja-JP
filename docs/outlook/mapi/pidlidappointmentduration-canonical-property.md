...
予定がスケジュールされている時間の長さを分単位で表します。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidapptduration  <br/> |
|プロパティセット:  <br/> |PSETID_Appointment  <br/> |
|ロング ID (LID):  <br/> |0x00008213  <br/> |
|データの種類 :   <br/> |PT_LONG  <br/> |
|エリア:  <br/> |カレンダー  <br/> |
   
## <a name="remarks"></a>解説

この値は、 **dispidapptstartwhole** ([PidLidAppointmentStartWhole](pidlidappointmentstartwhole-canonical-property.md)) と**dispidApptEndWhole** ([PidLidAppointmentEndWhole](pidlidappointmentendwhole-canonical-property.md)) の各プロパティの値の間の分数である必要があります。
