...
|**PR_MESSAGE_CLASS** ([PidTagMessageClass](pidtagmessageclass-canonical-property.md))  <br/> |送信メッセージでクライアントによって設定できます。クライアントによって設定されていない場合は、メッセージ ストア プロバイダーによって設定する必要があります。  <br/> |
|**PR_MESSAGE_FLAGS** ([PidTagMessageFlags](pidtagmessageflags-canonical-property.md))  <br/> |クライアントが送信メッセージを保存する前に設定し、保存後にメッセージ ストア プロバイダーを設定します。  <br/> |
...
|**PR_MESSAGE_CC_ME** ([PidTagMessageCcMe](pidtagmessageccme-canonical-property.md))  <br/> **PR_MESSAGE_RECIP_ME** ([PidTagMessageRecipientMe](pidtagmessagerecipientme-canonical-property.md))  <br/> **PR_MESSAGE_TO_ME** ([PidTagMessageToMe](pidtagmessagetome-canonical-property.md))  <br/> |受信メッセージのトランスポート プロバイダーによって設定されます。  <br/> |
|||
|**PR_NORMALIZED_SUBJECT** ([PidTagNormalizedSubject](pidtagnormalizedsubject-canonical-property.md))  <br/> |送信メッセージのメッセージ ストア プロバイダーによって設定される  <br/> |
...
|**PR_RECIPIENT_TYPE** ([PidTagRecipientType](pidtagrecipienttype-canonical-property.md))  <br/> |受信メッセージのメッセージ ストア プロバイダーによって設定されます。  <br/> |
