...
---
# <a name="pidlidlinkedtaskitems-canonical-property"></a>PidLidLinkedTaskItems の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
予定表に関連するタスクの**PR_ENTRYID** ([PidTagEntryId](pidtagentryid-canonical-property.md)) のプロパティの一覧を指定します。 
