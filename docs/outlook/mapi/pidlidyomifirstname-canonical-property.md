...
---
# <a name="pidlidyomifirstname-canonical-property"></a>PidLidYomiFirstName 標準プロパティ

  
  
**適用対象**: Outlook 2013 | Outlook 2016 
  
連絡先の特定の名前のふりがなを指定します。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidヨーク mifirstname  <br/> |
|プロパティセット:  <br/> |PSETID_Address  <br/> |
|ロング ID (LID):  <br/> |0x0000802c  <br/> |
