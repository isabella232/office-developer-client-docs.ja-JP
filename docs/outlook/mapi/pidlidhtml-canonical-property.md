...
このプロパティの値が存在する場合は、プロパティ ([PidTagBusinessHomePage](pidtagbusinesshomepage-canonical-property.md) **)** プロパティのPR_BUSINESS_HOME_PAGEと同じ値を指定する必要があります。
