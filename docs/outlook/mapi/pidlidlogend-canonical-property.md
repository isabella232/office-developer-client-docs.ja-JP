...
|ロング ID (LID):  <br/> |0x00008708  <br/> |
|データの種類 :   <br/> |PT_SYSTIME  <br/> |
|エリア:  <br/> |仕訳帳  <br/> |
   
## <a name="remarks"></a>解説

アクティビティが協定世界時 (UTC) で終了した時刻。これは、 **dispidcommonend** ([PidLidCommonEnd](pidlidcommonend-canonical-property.md)) プロパティと、 **dispidcommonend** ([PidLidLogStart](pidlidlogstart-canonical-property.md)) プロパティと同じである必要があります。
