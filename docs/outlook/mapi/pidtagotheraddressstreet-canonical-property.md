---
title: PidTagOtherAddressStreet の標準的なプロパティ
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidtagotheraddressstreet-canonical-property"></a>PidTagOtherAddressStreet の標準的なプロパティ
...
|||
|:-----|:-----|
|関連するプロパティ。  <br/> |PR_OTHER_ADDRESS_STREET、PR_OTHER_ADDRESS_STREET_A、PR_OTHER_ADDRESS_STREET_W  <br/> |
|識別子:  <br/> |0x3A63  <br/> |
