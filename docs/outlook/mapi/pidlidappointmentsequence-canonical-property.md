---
title: PidLidAppointmentSequence の標準的なプロパティ
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidlidappointmentsequence-canonical-property"></a>PidLidAppointmentSequence の標準的なプロパティ
...
|||
|:-----|:-----|
|関連するプロパティ。  <br/> |dispidApptSequence  <br/> |
|プロパティを設定します。  <br/> |PSETID_Appointment  <br/> |
|長い ID (LID):  <br/> |0x00008201  <br/> |
