...
---
# <a name="pidnamemultimediaclipcount-canonical-property"></a>PidNameMultimediaClipCount の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
ドキュメントに関連付けられているファイルでは、マルチ メディア クリップの数を指定します。
  
|||
|:-----|:-----|
|フレンドリ名:  <br/> |なし  <br/> |
|プロパティを設定します。  <br/> |PS_PUBLIC_STRINGS  <br/> |
|プロパティ名:  <br/> |MMClipCount  <br/> |
