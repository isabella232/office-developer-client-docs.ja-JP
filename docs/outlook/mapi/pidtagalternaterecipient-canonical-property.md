...
元の受信者によって指定された代替受信者のエントリ識別子の一覧が含まれる。 
...
このプロパティは、自動転送メッセージに使用されます。 代替受信者の [FLATENTRYLIST](flatentrylist.md) 構造が含まれる。 自動フォワードが許可されていない場合、または別の受信者が指定されていない場合は、配信以外のレポートが生成されます。 
