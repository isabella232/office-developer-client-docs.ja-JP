...
XML ファイルの発行元である RSS または Atom フィードの URL が含まれています。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidPostRssChannelLink  <br/> |
|プロパティセット:  <br/> |PSETID_PostRss  <br/> |
|ロング ID (LID):  <br/> |0x00008900  <br/> |
