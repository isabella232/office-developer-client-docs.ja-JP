...
ms.locfileid: "19802830"
---
# <a name="pidtaghtml-canonical-property"></a>PidTagHtml 標準プロパティ

  
  
**適用対象**: Outlook 
  
HTML 形式でメッセージ本文のテキストが含まれています。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |PR_HTML  <br/> |
|識別子:  <br/> |0x1013  <br/> |
