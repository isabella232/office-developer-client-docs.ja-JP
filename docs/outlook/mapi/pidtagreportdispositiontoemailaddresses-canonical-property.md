...
---
# <a name="pidtagreportdispositiontoemailaddresses-canonical-property"></a>PidTagReportDispositionToEmailAddresses 標準プロパティ

  
  
**適用対象**: Outlook 
  
領収書を要求するメッセージのレポートの受信者の電子メール アドレスを示します。
