...
---
# <a name="pidtagproviderdisplayname-canonical-property"></a>PidTagProviderDisplayName 標準プロパティ
...
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |PR_PROVIDER_DISPLAY_NAME、PR_PROVIDER_DISPLAY_NAME_A、PR_PROVIDER_DISPLAY_NAME_W  <br/> |
|識別子:  <br/> |0x3418  <br/> |
