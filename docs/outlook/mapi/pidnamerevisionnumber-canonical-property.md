---
title: PidNameRevisionNumber の標準的なプロパティ
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "19802357"
---
# <a name="pidnamerevisionnumber-canonical-property"></a>PidNameRevisionNumber の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
ドキュメントに関連付けられているファイルのリビジョン番号を指定します。
  
|||
|:-----|:-----|
|フレンドリ名:  <br/> |なし  <br/> |
|プロパティを設定します。  <br/> |PS_PUBLIC_STRINGS  <br/> |
|プロパティ名:  <br/> |RevNumber  <br/> |
