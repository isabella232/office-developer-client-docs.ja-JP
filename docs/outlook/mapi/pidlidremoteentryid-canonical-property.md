...
ms.locfileid: "59604489"
---
# <a name="pidlidremoteentryid-canonical-property"></a>PidLidRemoteEntryId 標準プロパティ

  
  
**適用対象**: Outlook 2013 | Outlook 2016 
  
リモート アイテムのエントリ ID を示します。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidRemoteEID  <br/> |
|プロパティ セット:  <br/> |PSETID_Remote  <br/> |
|長い ID (LID):  <br/> |0x00008F01  <br/> |
