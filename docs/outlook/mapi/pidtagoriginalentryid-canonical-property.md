...
アドレス帳から個人用アドレス帳またはその他の書き込み可能なアドレス帳にコピーされたエントリの元のエントリ識別子を含みます。
...
非開封レポートの場合、このプロパティには、レポートが生成される元のメッセージ受信者のエントリ id のコピーが含まれます。 元の受信者が配布リストの一部である場合は、配布リストのエントリ識別子がレポート用に保持されます。
