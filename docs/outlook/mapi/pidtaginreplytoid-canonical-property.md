...
元のメッセージの**PR_INTERNET_MESSAGE_ID** ([PidTagInternetMessageId](pidtaginternetmessageid-canonical-property.md)) プロパティの値が含まれています。
...
これらのプロパティは、すべてのメッセージの返信に設定する必要があります。
