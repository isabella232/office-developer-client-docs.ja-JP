...
元のメッセージのプロパティ [(PidTagInternetMessageId)](pidtaginternetmessageid-canonical-property.md) **PR_INTERNET_MESSAGE_IDプロパティ** 値を格納します。
...
これらのプロパティは、すべてのメッセージ返信で設定する必要があります。
