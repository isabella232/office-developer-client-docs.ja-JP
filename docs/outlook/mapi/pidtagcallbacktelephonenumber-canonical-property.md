---
title: PidTagCallbackTelephoneNumber 標準プロパティ
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "32345690"
---
# <a name="pidtagcallbacktelephonenumber-canonical-property"></a>PidTagCallbackTelephoneNumber 標準プロパティ

  
  
**適用対象**: Outlook 2013 | Outlook 2016 
  
メッセージ受信者が送信者に到達するために使用できる電話番号が含まれています。 
...
これらのプロパティは、受信者に関する id とアクセス情報を提供するプロパティの例です。 受信者と受信者の組織によって定義されます。 
