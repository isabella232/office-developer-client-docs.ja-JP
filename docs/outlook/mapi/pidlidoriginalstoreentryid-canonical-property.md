...
---
# <a name="pidlidoriginalstoreentryid-canonical-property"></a>PidLidOriginalStoreEntryId の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
代理人のストアのエントリ ID を指定します。
...
作成または代理人によって更新された会議のオブジェクトに対してこのプロパティを設定する必要があります。
