...
ms.locfileid: "32319538"
---
# <a name="pidlidcontactuserfield3-canonical-property"></a>PidLidContactUserField3 標準プロパティ

  
  
**適用対象**: Outlook 2013 | Outlook 2016 
  
連絡先のその他の使用を目的としている連絡先の3番目のフィールドを指定します。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidContactUserField3  <br/> |
|プロパティセット:  <br/> |PSETID_Address  <br/> |
|ロング ID (LID):  <br/> |0x00008051  <br/> |
|データの種類 :   <br/> |PT_UNICODE  <br/> |
|エリア:  <br/> |連絡先  <br/> |
   
## <a name="remarks"></a>解説

このプロパティには、他の連絡先固有のプロパティとは無関係のテキストが含まれています。
