...
連絡先を名刺として表示するためのユーザーカスタマイズの詳細が含まれています。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidbcdisplaydefinition  <br/> |
|プロパティセット:  <br/> |PSETID_Address  <br/> |
|ロング ID (LID):  <br/> |0x00008040  <br/> |
|データの種類 :   <br/> |PT_BINARY  <br/> |
|エリア:  <br/> |連絡先  <br/> |
   
## <a name="remarks"></a>解説

名刺のレイアウトは、画像と複数のテキストフィールドとして表すことができます。 画像は、連絡先の写真、またはカードの画像のいずれかにすることができます。 テキストフィールドは、連絡先の他のプロパティセットからの値と、ユーザーによって提供されるオプションのカスタマイズされたラベル文字列で構成されます。 マルチバイト値は、バッファーにリトルエンディアン形式で格納されることに注意してください。
