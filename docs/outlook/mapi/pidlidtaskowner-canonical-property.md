---
title: PidLidTaskOwner の標準的なプロパティ
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidlidtaskowner-canonical-property"></a>PidLidTaskOwner の標準的なプロパティ
...
|||
|:-----|:-----|
|関連するプロパティ。  <br/> |dispidTaskOwner  <br/> |
|プロパティを設定します。  <br/> |PSETID_Task  <br/> |
|長い ID (LID):  <br/> |0x0000811F  <br/> |
