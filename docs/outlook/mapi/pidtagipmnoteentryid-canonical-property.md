...
---
# <a name="pidtagipmnoteentryid-canonical-property"></a>PidTagIpmNoteEntryId 標準プロパティ

  
  
**適用対象**: Outlook 2013 | Outlook 2016 
  
Outlook のメモフォルダーの**EntryID**が含まれます。 
...
2. * * IMsgStore:: getreceivefolder * * 成功した場合は、受信トレイおよび[IMsgStore:: openentry](imsgstore-openentry.md)の**EntryID**への参照を使用して、受信トレイを開き、 **imapifolder**オブジェクトへの参照を取得します。 
