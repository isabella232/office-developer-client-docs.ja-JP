...
---
# <a name="pidlidemail1emailaddress-canonical-property"></a>PidLidEmail1EmailAddress 標準プロパティ

  
  
**適用対象**: Outlook 2013 | Outlook 2016 
  
連絡先の最初の電子メールアドレスを指定します。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidEmail1EmailAddress  <br/> |
|プロパティセット:  <br/> |PSETID_Address  <br/> |
|ロング ID (LID):  <br/> |0x00008083  <br/> |
|データの種類 :   <br/> |PT_UNICODE  <br/> |
|エリア:  <br/> |連絡先  <br/> |
   
## <a name="remarks"></a>解説

このプロパティの値は、この電子メールアドレスに対して指定されているアドレスの種類に対して適切である必要があります。
