...
---
# <a name="pidtagphysicalforwardingprohibited-canonical-property"></a>PidTagPhysicalForwardingProhibited の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
メッセージの送信者には、特定の受信者のメッセージの物理的な転送が禁止されている場合 TRUE が含まれています。
