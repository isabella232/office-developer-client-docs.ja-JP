...
スケジュールアプリケーションによって管理される予定の開始日時が含まれます。
...
スケジュールアプリケーションでは、会議出席依頼を送信するときに、このプロパティと**PR_END_DATE** ([PidTagEndDate](pidtagenddate-canonical-property.md)) プロパティの両方を設定する必要があります。
