---
title: PidLidCurrentVersion 標準プロパティ
manager: soliver
ms.date: 03/09/2015
...
アイテムを Outlook アプリケーションのビルド番号を表す長整数型の値が含まれています。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidCurrentVersion  <br/> |
|プロパティを設定します。  <br/> |PSETID_Common  <br/> |
|長い ID (LID):  <br/> |0x00008552  <br/> |
