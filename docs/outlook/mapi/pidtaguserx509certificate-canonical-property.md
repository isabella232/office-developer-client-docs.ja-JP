...
このプロパティは、公開キーセキュリティを使用するアプリケーションによって使用されます。 1つまたは複数の x.509 バージョン3セキュリティ証明書のバイナリ表現を保持します。 
  
さまざまなアプリケーションとクライアントは、独自のセキュリティ証明書にこのプロパティを使用できます。 x.509 データのバイナリ形式は、ベンダーによって異なる場合があります。 
