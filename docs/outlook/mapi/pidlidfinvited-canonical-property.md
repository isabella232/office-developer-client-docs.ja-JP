...
この会議が表す会議の招待状が送信されているかどうかを示します。
  
|||
|:-----|:-----|
|関連するプロパティ:  <br/> |dispidfinvited  <br/> |
|プロパティセット:  <br/> |PSETID_Appointment  <br/> |
|ロング ID (LID):  <br/> |0x00008229  <br/> |
|データの種類 :   <br/> |PT_BOOLEAN  <br/> |
|エリア:  <br/> |Meetings  <br/> |
   
## <a name="remarks"></a>解説

値が FALSE の場合、またはこのプロパティが存在しない場合は、会議出席依頼が送信されていないことを示します。 TRUE の値は、会議出席依頼が送信されたことを示します。 会議でこの値を TRUE に設定すると、変更する必要はありません。
