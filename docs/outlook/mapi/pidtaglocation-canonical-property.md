...
---
# <a name="pidtaglocation-canonical-property"></a>PidTagLocation の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
受信者の組織に役に立つ形式で受信者の場所が含まれています。 
...
内容は、受信者の組織のニーズによって定義されます。 などの一部の組織では、建物の番号とオフィス番号を指定することでメッセージング ユーザーを識別する可能性があります。 
