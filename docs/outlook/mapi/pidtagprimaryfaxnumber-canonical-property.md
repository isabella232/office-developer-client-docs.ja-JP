...
---
# <a name="pidtagprimaryfaxnumber-canonical-property"></a>PidTagPrimaryFaxNumber の標準的なプロパティ
...
|||
|:-----|:-----|
|関連するプロパティ。  <br/> |PR_PRIMARY_FAX_NUMBER、PR_PRIMARY_FAX_NUMBER_A、PR_PRIMARY_FAX_NUMBER_W  <br/> |
|識別子:  <br/> |0x3A23  <br/> |
