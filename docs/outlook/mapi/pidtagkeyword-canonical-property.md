...
---
# <a name="pidtagkeyword-canonical-property"></a>PidTagKeyword の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
受信者は受信者のシステム管理者を指定するキーワードが含まれています。
  
|||
|:-----|:-----|
|関連するプロパティ。  <br/> |PR_KEYWORD、PR_KEYWORD_A、PR_KEYWORD_W  <br/> |
|識別子:  <br/> |0x3A0B  <br/> |
