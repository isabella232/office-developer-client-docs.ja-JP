...
---
# <a name="pidtagrelatedmessageids-canonical-property"></a>PidTagRelatedMessageIds の標準的なプロパティ
...
**PR_SEARCH_KEY** ([PidTagSearchKey](pidtagsearchkey-canonical-property.md)) プロパティを使用すると、識別子は特定の形式と同じ規則を使用します。
