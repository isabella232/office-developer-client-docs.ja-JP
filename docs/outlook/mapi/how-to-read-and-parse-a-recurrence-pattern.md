...
3. <span data-ttu-id="457cd-112">予定の定期的なパターンの構造を読み取るには、 [[MS OXOCAL]](http://msdn.microsoft.com/en-us/library/cc425490%28EXCHG.80%29.aspx)の指示に従います。</span><span class="sxs-lookup"><span data-stu-id="457cd-112">Follow the guidance in [[MS-OXOCAL]](http://msdn.microsoft.com/en-us/library/cc425490%28EXCHG.80%29.aspx) to read the appointment recurrence pattern structure.</span></span> 
...
- [<span data-ttu-id="457cd-131">MAPI を使用して Outlook 2007 のアイテムを作成するには</span><span class="sxs-lookup"><span data-stu-id="457cd-131">Using MAPI to Create Outlook 2007 Items</span></span>](http://msdn.microsoft.com/en-us/library/cc678348%28office.12%29.aspx)
