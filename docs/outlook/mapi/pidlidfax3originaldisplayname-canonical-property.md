---
title: PidLidFax3OriginalDisplayName の標準的なプロパティ
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "19801975"
---
# <a name="pidlidfax3originaldisplayname-canonical-property"></a>PidLidFax3OriginalDisplayName の標準的なプロパティ

  
  
**適用されます**: Outlook 
  
連絡先の元の表示名はの他の fax アドレスを指定します。
