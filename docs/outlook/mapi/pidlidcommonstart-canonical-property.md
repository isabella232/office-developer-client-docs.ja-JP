...
---
# <a name="pidlidcommonstart-canonical-property"></a>PidLidCommonStart 標準プロパティ
...
|ロング ID (LID):  <br/> |0x00008516  <br/> |
|データの種類 :   <br/> |PT_SYSTIME  <br/> |
|エリア:  <br/> |一般的なメッセージング  <br/> |
   
## <a name="remarks"></a>解説

このプロパティは、アイテムの開始時刻を示します。 この値は、 **dispidcommonend** ([PidLidCommonEnd](pidlidcommonend-canonical-property.md)) プロパティの値以下である必要があります。
  
このプロパティの値は、 **dispidtaskstartdate** ([PidLidTaskStartDate](pidlidtaskstartdate-canonical-property.md)) プロパティと同等の協定世界時 (UTC) であることが必要です。
