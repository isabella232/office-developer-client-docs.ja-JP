...
---
# <a name="pidlidappointmentproposedendwhole-canonical-property"></a>PidLidAppointmentProposedEndWhole 標準プロパティ

  
  
**適用対象**: Outlook 2013 | Outlook 2016 
  
カウンター提案の**dispidApptEndWhole** ([PidLidAppointmentEndWhole](pidlidappointmentendwhole-canonical-property.md)) プロパティに対して提案された値を指定します。
