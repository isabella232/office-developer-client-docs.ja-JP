...
スケジュールアプリケーションによって管理される予定の終了日時を含みます。 
...
スケジュールアプリケーションでは、会議出席依頼を送信するときに、 **PR_START_DATE** ([PidTagStartDate](pidtagstartdate-canonical-property.md)) およびこのプロパティの両方を設定する必要があります。 
