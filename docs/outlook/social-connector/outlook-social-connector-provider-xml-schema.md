...
---
# <a name="outlook-social-connector-provider-xml-schema"></a><span data-ttu-id="0c691-104">Outlook ソーシャル コネクタ プロバイダーの XML スキーマ</span><span class="sxs-lookup"><span data-stu-id="0c691-104">Outlook Social Connector provider XML schema</span></span>

<span data-ttu-id="0c691-105">OSC プロバイダーの拡張メソッドの OSC プロバイダーによって返されるすべての XML は、OSC プロバイダーの次の XML スキーマに準拠する必要があります。</span><span class="sxs-lookup"><span data-stu-id="0c691-105">All XML that is returned by OSC providers in OSC provider extensibility methods must comply with the following OSC provider XML schema.</span></span> <span data-ttu-id="0c691-106">OSC スキーマが完全にここで再現します。</span><span class="sxs-lookup"><span data-stu-id="0c691-106">The OSC schema is reproduced here in its entirety.</span></span> <span data-ttu-id="0c691-107">現在のスキーマ定義ファイル、OutlookSocialProvider1_1.xsd は、この記事に付属するプロバイダー テンプレートのダウンロードにも提供されます。</span><span class="sxs-lookup"><span data-stu-id="0c691-107">The current schema definition file, OutlookSocialProvider1_1.xsd, is also provided in the download for the provider templates that accompany this article.</span></span> <span data-ttu-id="0c691-108">詳細についてを参照してください[Outlook ソーシャル コネクタ 2013: プロバイダー テンプレート](http://code.msdn.microsoft.com/Outlook-Social-Connector-73fd8d2c)。</span><span class="sxs-lookup"><span data-stu-id="0c691-108">For more information, see [Outlook Social Connector 2013: Provider templates](http://code.msdn.microsoft.com/Outlook-Social-Connector-73fd8d2c).</span></span> 
...
## <a name="see-also"></a><span data-ttu-id="0c691-109">関連項目</span><span class="sxs-lookup"><span data-stu-id="0c691-109">See also</span></span>

- [<span data-ttu-id="0c691-110">機能の XML の例</span><span class="sxs-lookup"><span data-stu-id="0c691-110">Capabilities XML Example</span></span>](capabilities-xml-example.md)  
- [<span data-ttu-id="0c691-111">友人の XML の例</span><span class="sxs-lookup"><span data-stu-id="0c691-111">Friends XML Example</span></span>](friends-xml-example.md) 
- [<span data-ttu-id="0c691-112">アクティビティ フィードの XML の例</span><span class="sxs-lookup"><span data-stu-id="0c691-112">Activity Feed XML Example</span></span>](activity-feed-xml-example.md)  
- [<span data-ttu-id="0c691-113">機能のための XML</span><span class="sxs-lookup"><span data-stu-id="0c691-113">XML for Capabilities</span></span>](xml-for-capabilities.md)  
- [<span data-ttu-id="0c691-114">友人の XML</span><span class="sxs-lookup"><span data-stu-id="0c691-114">XML for Friends</span></span>](xml-for-friends.md)  
- [<span data-ttu-id="0c691-115">活動の XML</span><span class="sxs-lookup"><span data-stu-id="0c691-115">XML for Activities</span></span>](xml-for-activities.md)  
- [<span data-ttu-id="0c691-116">Outlook ソーシャル コネクタ プロバイダー インターフェイス</span><span class="sxs-lookup"><span data-stu-id="0c691-116">Outlook Social Connector Provider Interfaces</span></span>](outlook-social-connector-provider-interfaces.md)
