...
- [Outlook VBA リファレンス](https://msdn.microsoft.com/EN-US/library/ee861520.aspx)
  
- [Outlook 2010](https://msdn.microsoft.com/en-us/library/cc313152%28v=office.12%29.aspx)
  
### <a name="office-add-ins"></a>Office アドイン
  
- [Outlook アドインの使用を開始する](https://docs.microsoft.com/en-us/outlook/add-ins/quick-start)
