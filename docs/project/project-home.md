...
- [Project VBA リファレンス](https://msdn.microsoft.com/en-us/library/dn175495.aspx)
  
- [Project 2010](https://msdn.microsoft.com/EN-US/library/ee861523.aspx)
  
### <a name="office-add-ins"></a>Office アドイン
  
- [Project アドインの使用を開始する](https://docs.microsoft.com/en-us/office/dev/add-ins/quickstarts/project-quickstart )
...
- [Office 用 VSTO アドイン](https://docs.microsoft.com/en-us/office/dev/add-ins/overview/office-add-ins)
