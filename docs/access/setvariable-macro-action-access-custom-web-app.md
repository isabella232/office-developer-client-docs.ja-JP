...
---
# <a name="setvariable-macro-action-access-custom-web-app"></a>SetVariable マクロのアクション (カスタム web アプリケーションのアクセス)
...
|**値 =** <br/> |この一時変数の値を設定するために使用する式を入力します。 等号を含む式の前の操作を行います (**=** ) 記号。 この引数を設定するのには、式ビルダーを使用する![数式](media/buildbut_ZA06047218.gif "数式")の [**ビルド**] ボタンをクリックすることができます。  <br/> |
