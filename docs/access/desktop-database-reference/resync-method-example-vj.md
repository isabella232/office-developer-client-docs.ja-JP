...
---
# <a name="resync-method-example-vj"></a><span data-ttu-id="b4d9e-102">Resync メソッドの使用例 (VJ++)</span><span class="sxs-lookup"><span data-stu-id="b4d9e-102">Resync Method Example (VJ++)</span></span>


<span data-ttu-id="b4d9e-103">**適用されます**Access 2013 |。Office 2013</span><span class="sxs-lookup"><span data-stu-id="b4d9e-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="b4d9e-104">この例では、[Resync](resync-method-ado.md) メソッドを使用して、静的レコードセット内のデータを更新する方法を示します。</span><span class="sxs-lookup"><span data-stu-id="b4d9e-104">This example demonstrates using the [Resync](resync-method-ado.md) method to refresh data in a static recordset.</span></span>
