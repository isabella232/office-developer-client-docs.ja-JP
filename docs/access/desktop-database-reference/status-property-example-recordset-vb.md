...
ms.locfileid: "25477248"
---
# <a name="status-property-example-recordset-vb"></a><span data-ttu-id="9fed1-102">Status プロパティの使用例 (Recordset) (VB)</span><span class="sxs-lookup"><span data-stu-id="9fed1-102">Status Property Example (Recordset) (VB)</span></span>


<span data-ttu-id="9fed1-103">**適用されます**Access 2013 |。Office 2013</span><span class="sxs-lookup"><span data-stu-id="9fed1-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="9fed1-104">この例では、[Status](status-property-ado-recordset.md) プロパティを使用して、一括更新の前にバッチ処理で変更されたレコードを表示します。</span><span class="sxs-lookup"><span data-stu-id="9fed1-104">This example uses the [Status](status-property-ado-recordset.md) property to display which records have been modified in a batch operation before a batch update has occurred.</span></span>
