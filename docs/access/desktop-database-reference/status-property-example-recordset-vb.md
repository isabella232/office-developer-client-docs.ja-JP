...
---
# <a name="status-property-example-recordset-vb"></a><span data-ttu-id="c98bf-102">Status プロパティの使用例 (Recordset) (VB)</span><span class="sxs-lookup"><span data-stu-id="c98bf-102">Status property example (Recordset) (VB)</span></span>


<span data-ttu-id="c98bf-103">**適用先:** Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="c98bf-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="c98bf-104">この例では、[Status](status-property-ado-recordset.md) プロパティを使用して、一括更新の前にバッチ処理で変更されたレコードを表示します。</span><span class="sxs-lookup"><span data-stu-id="c98bf-104">This example uses the [Status](status-property-ado-recordset.md) property to display which records have been modified in a batch operation before a batch update has occurred.</span></span>
