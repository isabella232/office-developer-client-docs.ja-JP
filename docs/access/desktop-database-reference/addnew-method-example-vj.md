...
ms.locfileid: "32281861"
---
# <a name="addnew-method-example-vj"></a><span data-ttu-id="dc087-102">AddNew メソッドの使用例 (VJ++)</span><span class="sxs-lookup"><span data-stu-id="dc087-102">AddNew method example (VJ++)</span></span>


<span data-ttu-id="dc087-103">**適用先:** Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="dc087-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="dc087-104">この例では、 [AddNew](addnew-method-ado.md) メソッドを使用して、指定した名前を持つ新しいレコードを作成します。</span><span class="sxs-lookup"><span data-stu-id="dc087-104">This example uses the [AddNew](addnew-method-ado.md) method to create a new record with the specified name.</span></span>
