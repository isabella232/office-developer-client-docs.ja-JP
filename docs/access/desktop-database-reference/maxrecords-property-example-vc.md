...
ms.locfileid: "32289708"
---
# <a name="maxrecords-property-example-vc"></a><span data-ttu-id="b7cfe-102">MaxRecords プロパティの使用例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="b7cfe-102">MaxRecords property example (VC++)</span></span>


<span data-ttu-id="b7cfe-103">**適用先:** Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="b7cfe-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="b7cfe-104">次の例では、[MaxRecords](maxrecords-property-ado.md) プロパティを使って、***Titles*** テーブル中の最も価格の高い 10 タイトルを含む [Recordset](recordset-object-ado.md) を開きます。</span><span class="sxs-lookup"><span data-stu-id="b7cfe-104">This example uses the [MaxRecords](maxrecords-property-ado.md) property to open a [Recordset](recordset-object-ado.md) containing the 10 most expensive titles in the ***Titles*** table.</span></span>
