---
title: Indexes の Append メソッドの使用例 (VC++)
...
ms.locfileid: "28707725"
---
# <a name="indexes-append-method-example-vc"></a><span data-ttu-id="29c0d-102">Indexes の Append メソッドの使用例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="29c0d-102">Indexes Append method example (VC++)</span></span>


<span data-ttu-id="29c0d-103">**適用されます**Access 2013、Office 2013。</span><span class="sxs-lookup"><span data-stu-id="29c0d-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="29c0d-p101">次のコードでは、新しいインデックスの作成方法を示します。インデックスは、テーブル内の 2 つの列に追加されます。</span><span class="sxs-lookup"><span data-stu-id="29c0d-p101">The following code demonstrates how to create a new index. The index is on two columns in the table.</span></span>
