...
- [DefaultDatabase プロパティ](defaultdatabase-property-ado.md)
- [Errors コレクション](errors-collection-ado.md)
- [IsolationLevel プロパティ](isolationlevel-property-ado.md)
- [Mode プロパティ](mode-property-ado.md)
- [Properties コレクション](properties-collection-ado.md)
- [Provider プロパティ](provider-property-ado.md)
...
- [WillConnect イベント](willconnect-event-ado.md)
- [WillExecute イベント](willexecute-event-ado.md)
