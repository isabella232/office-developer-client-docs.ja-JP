---
title: Hierarchies コレクション (ADO MD リファレンス)
...
ms.locfileid: "25886341"
---
# <a name="hierarchies-collection-ado-md-reference"></a>Hierarchies コレクション (ADO MD リファレンス)
...
**適用されます**Access 2013、Office 2013。
  ...
  - [Hierarchies コレクションのプロパティ、メソッド、およびイベント (ADO MD)](hierarchies-collection-properties-methods-and-events-ado-md.md)
