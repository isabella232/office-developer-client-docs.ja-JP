...
ms.locfileid: "28714592"
---
# <a name="database-properties-dao"></a>データベース プロパティ (DAO)

**適用されます**Access 2013、Office 2013。

- [Database.CollatingOrder プロパティ (DAO)](database-collatingorder-property-dao.md)
- [Database.Connect プロパティ (DAO)](database-connect-property-dao.md)
