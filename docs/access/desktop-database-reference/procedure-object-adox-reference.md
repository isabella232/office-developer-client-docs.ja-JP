---
title: Procedure オブジェクト (ADOX) リファレンス
...
ms.locfileid: "32301387"
---
# <a name="procedure-object-adox-reference"></a>Procedure オブジェクト (ADOX) リファレンス

**適用先:** Access 2013、Office 2013

- [Procedure オブジェクト (ADOX)](procedure-object-adox.md)
- [Procedure のプロパティ、メソッド、およびイベント (ADOX)](procedure-properties-methods-and-events-adox.md)
