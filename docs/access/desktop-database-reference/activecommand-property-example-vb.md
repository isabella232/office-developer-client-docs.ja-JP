---
<<<<<<< ヘッド タイトル: ActiveCommand プロパティの使用例 (VB) TOCTitle: ActiveCommand プロパティの使用例 (VB) ms:assetid: 831032cb-d557-aa98-5637-07bad65f924a ms:mtpsurl: https://msdn.microsoft.com/library/JJ249569(v=office.15) ms:contentKeyID: 48545999 ms.date: 2015/09/18 mtps_バージョン: v=office.15
---

# <a name="activecommand-property-example-vb"></a>ActiveCommand プロパティの使用例 (VB)
=== タイトル: ActiveCommand プロパティの使用例 (VB) TOCTitle: ActiveCommand プロパティの使用例 (VB) ms:assetid: 831032cb-d557-aa98-5637-07bad65f924a ms:mtpsurl: https://msdn.microsoft.com/library/JJ249569(v=office.15) ms:contentKeyID: 48545999 ms.date: 2018/10/17 mtps_version: v=office.15
---
