...
**メソッド**
  ...
  - [AddNew メソッドの使用例 (VJ++)](addnew-method-example-vb.md)

  - [Append メソッドおよび CreateParameter メソッドの使用例 (VJ++)](append-and-createparameter-methods-example-vb.md)

  - [AppendChunk メソッドと GetChunk メソッドの使用例 (VJ++)](appendchunk-and-getchunk-methods-example-vb.md)

  - [BeginTrans メソッド、CommitTrans メソッド、および RollbackTrans メソッドの使用例 (VJ++)](begintrans-committrans-and-rollbacktrans-methods-example-vb.md)

  - [Cancel メソッドの使用例 (VJ++)](cancel-method-example-vb.md)

  - [Clone メソッドの使用例 (VJ++)](clone-method-example-vb.md)
  ...
  - [CopyRecord メソッド、CopyTo メソッド、および SaveToFile メソッドの使用例 (VB)](copyrecord-copyto-and-savetofile-methods-example-vb.md)

  - [CreateRecordset メソッドの使用例 (VB)](createrecordset-method-example-vb.md)

  - [Delete メソッドの使用例 (VB)](delete-method-example-vb.md)

  - [DeleteRecord メソッドおよび MoveRecord メソッドの使用例 (VB)](deleterecord-and-moverecord-methods-example-vb.md)

  - [Execute メソッド、Requery メソッド、および Clear メソッドの使用例 (VB)](execute-requery-and-clear-methods-example-vb.md)

  - [Find メソッドの使用例 (VJ++)](find-method-example-vb.md)
...
>>>>>>> master
  ...
  - [MoveFirst、MoveLast、MoveNext、および MovePrevious メソッドの使用例 (VB)](movefirst-movelast-movenext-and-moveprevious-methods-example-vb.md)

  - [NextRecordset メソッドの使用例 (VJ++)](nextrecordset-method-example-vb.md)

  - [Open メソッドおよび Close メソッドの使用例 (VJ++)](open-and-close-methods-example-vb.md)

  - [OpenSchema メソッドの使用例 (VB)](openschema-method-example-vb.md)

  - [Read、ReadText、Write、および WriteText メソッドの使用例 (VB)](read-readtext-write-and-writetext-methods-example-vb.md)
...
>>>>>>> master
  ...
  - [UpdateBatch メソッドおよび CancelBatch メソッドの使用例 (VJ++)](updatebatch-and-cancelbatch-methods-example-vb.md)
