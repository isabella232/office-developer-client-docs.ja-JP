...
<span data-ttu-id="115cf-111">**TransferSpreadsheet** アクションの引数は次のとおりです。</span><span class="sxs-lookup"><span data-stu-id="115cf-111">The **TransferSpreadsheet** action has the following arguments.</span></span>
