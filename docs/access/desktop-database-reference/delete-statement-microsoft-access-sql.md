...
[FROM](https://msdn.microsoft.com/library/ff836674\(v=office.15\)) 句で指定したテーブルから [WHERE](https://msdn.microsoft.com/library/ff195245\(v=office.15\)) 句の条件を満たすレコードを削除する削除クエリを作成します。
