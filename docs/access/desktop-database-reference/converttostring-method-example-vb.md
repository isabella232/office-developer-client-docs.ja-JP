...
ms.locfileid: "32295507"
---
# <a name="converttostring-method-example-vb"></a><span data-ttu-id="2d2fa-102">ConvertToString メソッドの使用例 (VB)</span><span class="sxs-lookup"><span data-stu-id="2d2fa-102">ConvertToString method example (VB)</span></span>


<span data-ttu-id="2d2fa-103">**適用先:** Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="2d2fa-103">**Applies to**: Access 2013, Office 2013</span></span>
