---
title: ConvertToString メソッドの使用例 (VB)
...
ms.locfileid: "28721466"
---
# <a name="converttostring-method-example-vb"></a><span data-ttu-id="4200a-102">ConvertToString メソッドの使用例 (VB)</span><span class="sxs-lookup"><span data-stu-id="4200a-102">ConvertToString method example (VB)</span></span>


<span data-ttu-id="4200a-103">**適用されます**Access 2013、Office 2013。</span><span class="sxs-lookup"><span data-stu-id="4200a-103">**Applies to**: Access 2013, Office 2013</span></span>
