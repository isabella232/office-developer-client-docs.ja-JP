...
ms.locfileid: "25890989"
---
# <a name="converttostring-method-example-vb"></a><span data-ttu-id="38225-102">ConvertToString メソッドの使用例 (VB)</span><span class="sxs-lookup"><span data-stu-id="38225-102">ConvertToString method example (VB)</span></span>


<span data-ttu-id="38225-103">**適用されます**Access 2013、Office 2013。</span><span class="sxs-lookup"><span data-stu-id="38225-103">**Applies to**: Access 2013, Office 2013</span></span>
