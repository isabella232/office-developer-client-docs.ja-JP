...
ms.locfileid: "25864096"
---
# <a name="nextrecordset-method-example-vc"></a><span data-ttu-id="f313c-102">NextRecordset メソッドの使用例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="f313c-102">NextRecordset method example (VC++)</span></span>


<span data-ttu-id="f313c-103">**適用されます**Access 2013 |。Office 2013</span><span class="sxs-lookup"><span data-stu-id="f313c-103">**Applies to**: Access 2013 | Office 2013</span></span>
