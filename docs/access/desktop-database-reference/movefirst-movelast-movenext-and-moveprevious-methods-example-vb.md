...
ms.locfileid: "25869254"
---
# <a name="movefirst-movelast-movenext-and-moveprevious-methods-example-vb"></a><span data-ttu-id="71c4c-102">MoveFirst メソッド、MoveLast メソッド、MoveNext メソッド、MovePrevious メソッドの使用例 (VB)</span><span class="sxs-lookup"><span data-stu-id="71c4c-102">MoveFirst, MoveLast, MoveNext, and MovePrevious methods example (VB)</span></span>


<span data-ttu-id="71c4c-103">**適用されます**Access 2013、Office 2013。</span><span class="sxs-lookup"><span data-stu-id="71c4c-103">**Applies to**: Access 2013, Office 2013</span></span>
