...
ms.locfileid: "25879250"
---
# <a name="command-and-commandtext-properties-example-vc"></a><span data-ttu-id="12110-102">Command プロパティと CommandText プロパティの使用例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="12110-102">Command and CommandText properties example (VC++)</span></span>


<span data-ttu-id="12110-103">**適用されます**Access 2013、Office 2013。</span><span class="sxs-lookup"><span data-stu-id="12110-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="12110-104">次のコードは、プロシージャのテキストを更新するための [Command](command-property-adox.md) プロパティの使用例を示しています。</span><span class="sxs-lookup"><span data-stu-id="12110-104">The following code demonstrates how to use the [Command](command-property-adox.md) property to update the text of a procedure.</span></span>
