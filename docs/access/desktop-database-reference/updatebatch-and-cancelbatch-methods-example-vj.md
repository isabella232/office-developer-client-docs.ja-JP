---
title: UpdateBatch メソッドと CancelBatch メソッドの使用例 (VJ++)
...
ms.locfileid: "25861870"
---
# <a name="updatebatch-and-cancelbatch-methods-example-vj"></a><span data-ttu-id="d50e2-102">UpdateBatch メソッドと CancelBatch メソッドの使用例 (VJ++)</span><span class="sxs-lookup"><span data-stu-id="d50e2-102">UpdateBatch and CancelBatch methods example (VJ++)</span></span>


<span data-ttu-id="d50e2-103">**適用されます**Access 2013 |。Office 2013</span><span class="sxs-lookup"><span data-stu-id="d50e2-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="d50e2-104">次の例では、[UpdateBatch](updatebatch-method-ado.md) メソッドと [CancelBatch](cancelbatch-method-ado.md) メソッドを組み合わせて使用する方法を示します。</span><span class="sxs-lookup"><span data-stu-id="d50e2-104">This example demonstrates the [UpdateBatch](updatebatch-method-ado.md) method in conjunction with the [CancelBatch](cancelbatch-method-ado.md) method.</span></span>
