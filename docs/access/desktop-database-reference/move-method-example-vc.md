...
ms.locfileid: "32288821"
---
# <a name="move-method-example-vc"></a><span data-ttu-id="37b96-102">Move メソッドの使用例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="37b96-102">Move method example (VC++)</span></span>

<span data-ttu-id="37b96-103">**適用先:** Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="37b96-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="37b96-104">この例では、[Move](move-method-ado.md) メソッドを使用して、ユーザーの入力に基づいてレコード ポインターを配置します。</span><span class="sxs-lookup"><span data-stu-id="37b96-104">This example uses the [Move](move-method-ado.md) method to position the record pointer based on user input.</span></span>
...
<span data-ttu-id="37b96-105">**movex**</span><span class="sxs-lookup"><span data-stu-id="37b96-105">**MoveX.h**</span></span>
