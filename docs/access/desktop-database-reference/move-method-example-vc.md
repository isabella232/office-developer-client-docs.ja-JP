...
---
# <a name="move-method-example-vc"></a><span data-ttu-id="1d8e1-102">Move メソッドの使用例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="1d8e1-102">Move method example (VC++)</span></span>

<span data-ttu-id="1d8e1-103">**適用されます**Access 2013、Office 2013。</span><span class="sxs-lookup"><span data-stu-id="1d8e1-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="1d8e1-104">この例では、[Move](move-method-ado.md) メソッドを使用して、ユーザーの入力に基づいてレコード ポインターを配置します。</span><span class="sxs-lookup"><span data-stu-id="1d8e1-104">This example uses the [Move](move-method-ado.md) method to position the record pointer based on user input.</span></span>
...
<span data-ttu-id="1d8e1-105">**MoveX.h**</span><span class="sxs-lookup"><span data-stu-id="1d8e1-105">**MoveX.h**</span></span>
