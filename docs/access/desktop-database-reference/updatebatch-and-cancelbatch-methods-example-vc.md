---
title: UpdateBatch メソッドと CancelBatch メソッドの使用例 (VC++)
...
ms.locfileid: "25861926"
---
# <a name="updatebatch-and-cancelbatch-methods-example-vc"></a><span data-ttu-id="d0234-102">UpdateBatch メソッドと CancelBatch メソッドの使用例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="d0234-102">UpdateBatch and CancelBatch methods example (VC++)</span></span>


<span data-ttu-id="d0234-103">**適用されます**Access 2013 |。Office 2013</span><span class="sxs-lookup"><span data-stu-id="d0234-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="d0234-104">次の例では、[UpdateBatch](updatebatch-method-ado.md) メソッドと [CancelBatch](cancelbatch-method-ado.md) メソッドを組み合わせて使用する方法を示します。</span><span class="sxs-lookup"><span data-stu-id="d0234-104">This example demonstrates the [UpdateBatch](updatebatch-method-ado.md) method in conjunction with the [CancelBatch](cancelbatch-method-ado.md) method.</span></span>
...
<span data-ttu-id="d0234-105">**UpdateBatchX.h**</span><span class="sxs-lookup"><span data-stu-id="d0234-105">**UpdateBatchX.h**</span></span>
