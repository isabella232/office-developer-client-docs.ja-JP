...
<td><p>基になるオブジェクトから <strong><a href="property-object-dao.md">Property</a></strong> オブジェクトが継承されるかどうかを示す値を取得します。</p></td>
</tr>
<tr class="even">
...
<tr class="even">
<td><p><strong><a href="property-type-property-dao.md">型</a></strong></p></td>
