...
ms.locfileid: "32296221"
---
# <a name="columns-and-tables-append-methods-name-property-example-vc"></a><span data-ttu-id="564a5-102">列とテーブルの Append メソッドと Name プロパティの使用例 (VC + +)</span><span class="sxs-lookup"><span data-stu-id="564a5-102">Columns and Tables Append Methods, Name property example (VC++)</span></span>


<span data-ttu-id="564a5-103">**適用先:** Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="564a5-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="564a5-104">次のコードでは、新しいテーブルの作成方法を示します。</span><span class="sxs-lookup"><span data-stu-id="564a5-104">The following code demonstrates how to create a new table.</span></span>
