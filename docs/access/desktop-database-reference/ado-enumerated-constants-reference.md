...
ms.locfileid: "25476681"
---
# <a name="ado-enumerated-constants-reference"></a>ADO 列挙定数リファレンス
...
**適用されます**Access 2013 |。Office 2013
  ...
  - [ADCPROP\_ASYNCTHREADPRIORITY\_列挙型](adcprop-asyncthreadpriority-enum.md)

  - [ADCPROP\_AUTORECALC\_列挙型](adcprop-autorecalc-enum.md)

  - [ADCPROP\_UPDATECRITERIA\_列挙型](adcprop-updatecriteria-enum.md)

  - [ADCPROP\_UPDATERESYNC\_列挙型](adcprop-updateresync-enum.md)
