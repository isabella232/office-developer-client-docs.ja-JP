...
---
# <a name="positions-collection-ado-md-reference"></a>位置コレクション (ADO MD リファレンス)

**適用先:** Access 2013、Office 2013

- [位置コレクション (ADO MD)](positions-collection-ado-md.md)
- [コレクションのプロパティ、メソッド、およびイベントを位置付ける (ADO MD)](positions-collection-properties-methods-and-events-ado-md.md)
