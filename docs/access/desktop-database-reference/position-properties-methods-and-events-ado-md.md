...
ms.locfileid: "25947351"
---
# <a name="position-properties-methods-and-events-ado-md"></a>位置プロパティ、メソッド、およびイベント (ADO MD)

**適用されます**Access 2013、Office 2013。

## <a name="propertiescollections"></a>プロパティ/コレクション

- [メンバーのコレクション](members-collection-ado-md.md)
- [Ordinal プロパティ (位置)](ordinal-property-ado-md-position.md)
