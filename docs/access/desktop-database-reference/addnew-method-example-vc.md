...
ms.locfileid: "28700326"
---
# <a name="addnew-method-example-vc"></a><span data-ttu-id="f9cdd-102">AddNew メソッドの使用例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="f9cdd-102">AddNew method example (VC++)</span></span>


<span data-ttu-id="f9cdd-103">**適用されます**Access 2013、Office 2013。</span><span class="sxs-lookup"><span data-stu-id="f9cdd-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="f9cdd-104">この例では、[AddNew](addnew-method-ado.md) メソッドを使用して、指定された名前で新しいレコードを作成します。</span><span class="sxs-lookup"><span data-stu-id="f9cdd-104">This example uses the [AddNew](addnew-method-ado.md) method to create a new record with the specified name.</span></span>
...
<span data-ttu-id="f9cdd-105">**AddNewX.h**</span><span class="sxs-lookup"><span data-stu-id="f9cdd-105">**AddNewX.h**</span></span>
