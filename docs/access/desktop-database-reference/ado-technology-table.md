...
<tr class="even">
<td><p>JScript</p></td>
<td><p><a href="handling-errors-in-other-languages.md">他のプログラミング言語でエラーを処理する</a><br/><br/><a href="jscript-ado-programming.md">JScript での ADO プログラミング</a><br/><br/><a href="ado-code-examples-in-microsoft-jscript.md">Microsoft JScript での ADO コードの例</a><br/><br/></p></td>
</tr>
<tr class="odd">
<td><p>ODBC</p></td>
<td><p><a href="the-role-of-ado-in-microsoft-data-access.md">Microsoft Data Access における ADO の役割</a><br/><br/><a href="using-the-connection-object-access.md">Connection オブジェクトを使用する</a><br/><br/><a href="using-rds-with-odbc-connection-pooling.md">RDS を ODBC 接続プールと共に使用する</a><br/><br/><a href="microsoft-ole-db-provider-for-odbc.md">Microsoft OLE DB Provider for ODBC</a><br/><br/></p></td>
</tr>
<tr class="even">
<td><p>OLE DB</p></td>
<td><p><a href="the-role-of-ado-in-microsoft-data-access.md">Microsoft Data Access における ADO の役割</a><br/><br/><a href="ole-db-providers.md">OLE DB プロバイダー</a><br/><br/><a href="appendix-a-providers.md">付録 A: プロバイダー</a><br/><br/><a href="provider-errors.md">Provider Errors</a><br/><br/></p></td>
</tr>
<tr class="odd">
<td><p>Oracle</p></td>
...
<td><p><a href="running-business-objects-in-component-services.md">コンポーネント サービスでビジネス オブジェクトを実行する</a><br/><br/></p></td>
</tr>
<tr class="even">
<td><p>VBScript</p></td>
<td><p><a href="handling-errors-in-other-languages.md">他のプログラミング言語でエラーを処理する</a><br/><br/><a href="visual-basic-for-applications-functions.md">Visual Basic for Applications の関数</a><br/><br/><a href="solutions-for-remote-data-access.md">リモート データ アクセスのソリューション</a><br/><br/><a href="rds-tutorial-vbscript.md">RDS チュートリアル (VBScript)</a><br/><br/><a href="vbscript-ado-programming.md">VBScript での ADO プログラミング</a><br/><br/><a href="ado-code-examples-in-microsoft-visual-basic-scripting-edition.md">Microsoft Visual Basic Scripting Edition での ADO コードの例</a><br/><br/></p></td>
</tr>
<tr class="odd">
