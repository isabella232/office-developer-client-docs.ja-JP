...
<td><p><strong><a href="recordset-object-dao.md">Recordset</a></strong>オブジェクトの<strong><a href="fields-collection-dao.md">Fields</a></strong>コレクションに含まれる、<strong>メモ型 (Memo</strong> ) または<strong>長い field2</strong>オブジェクトの内容のすべてまたは一部を返します。</p></td>
</tr>
<tr class="even">
...
<td><p>長さ0の文字列 (&quot;&quot;) が、テキスト型またはメモ型の<strong>Field2</strong>オブジェクトの<strong><a href="field-value-property-dao.md">value</a></strong>プロパティの有効な設定値かどうかを示す値を設定または取得します (Microsoft access ワークスペースのみ)。</p></td>
</tr>
<tr class="even">
...
<td><p><strong>Field2</strong>オブジェクトの1つ以上の特性を示す値を設定または取得します。 値の取得と設定が可能な長整数型 (<strong>Long</strong>) の値です。</p></td>
</tr>
<tr class="even">
...
<td><p>複数値を持つフィールドを表す <strong><a href="complextype-object-dao.md">ComplexType</a></strong> オブジェクトを返します。 読み取り専用です。</p></td>
</tr>
<tr class="even">
...
<tr class="even">
<td><p><strong><a href="field2-expression-property-dao.md">表現</a></strong></p></td>
<td><p>読み取り/書き込み</p></td>
</tr>
<tr class="odd">
...
<td><p><strong><a href="fields-collection-dao.md">Fields</a></strong>コレクション内の<strong>Field2</strong>オブジェクトの相対位置を設定または取得します。 .</p></td>
</tr>
<tr class="even">
...
<tr class="even">
<td><p><strong><a href="field2-sourcefield-property-dao.md">sourcefield プロパティ</a></strong></p></td>
