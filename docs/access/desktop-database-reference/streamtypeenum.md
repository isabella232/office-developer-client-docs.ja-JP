---
title: StreamTypeEnum (Access デスクトップ データベースリファレンス)
...
ms.locfileid: "59552417"
---
# <a name="streamtypeenum"></a>StreamTypeEnum

**適用先:** Access 2013、Office 2013

[Stream](stream-object-ado.md) オブジェクトに保存するデータの種類を表します。
...
<td><p>1</p></td>
<td><p>バイナリ データを示します。</p></td>
</tr>
<tr class="even">
<td><p><strong>adTypeText</strong></p></td>
<td><p>2</p></td>
<td><p>既定値。<a href="charset-property-ado.md">Charset</a> で指定された文字セットのテキスト データを示します。</p></td>
</tr>
</tbody>
</table>
