---
<<<<<<< ヘッド タイトル: ActiveCommand プロパティの使用例 (vc++) TOCTitle: ActiveCommand プロパティの使用例 (vc++) ms:assetid: 35ebe533-73bb-0fe5-ef94-973e124b25cd ms:mtpsurl: https://msdn.microsoft.com/library/JJ249118(v=office.15) ms:contentKeyID: 48544157 ms.date: 2015/09/18mtps_version: v=office.15
---

# <a name="activecommand-property-example-vc"></a>ActiveCommand プロパティの使用例 (VC++)

=== タイトル: ActiveCommand プロパティの使用例 (vc++) TOCTitle: ActiveCommand プロパティの使用例 (vc++) ms:assetid: 35ebe533-73bb-0fe5-ef94-973e124b25cd ms:mtpsurl: https://msdn.microsoft.com/library/JJ249118(v=office.15) ms:contentKeyID: 48544157 ms.date: 2018/10/17 mtps_version: v=office.15
---
