...
ms.locfileid: "25871382"
---
# <a name="ado-code-examples-in-microsoft-visual-j-access"></a>ADO コードの例で Microsoft Visual J では (アクセス)
...
**適用されます**Access 2013、Office 2013。
  ...
  - [AbsolutePage プロパティ、PageCount プロパティ、PageSize プロパティの使用例 (VJ++)](absolutepage-pagecount-and-pagesize-properties-example-vj.md)
  ...
  - [ActiveConnection プロパティ、CommandText プロパティ、CommandTimeout プロパティ、CommandType プロパティ、Size プロパティ、Direction プロパティの使用例 (VJ++)](activeconnection-commandtext-commandtimeout-commandtype-size-and-direction-properties-example-vj.md)
  ...
  - [Append メソッドと CreateParameter メソッドの使用例 (VJ++)](append-and-createparameter-methods-example-vj.md)
  ...
  - [BeginTrans メソッド、CommitTrans メソッド、RollbackTrans メソッドの使用例 (VJ++)](begintrans-committrans-and-rollbacktrans-methods-example-vj.md)

  - [BOF プロパティ、EOF プロパティ、Bookmark プロパティの使用例 (VJ++)](bof-eof-and-bookmark-properties-example-vj.md)
  ...
  - [ConnectionString プロパティ、ConnectionTimeout プロパティ、State プロパティの使用例 (VJ++)](connectionstring-connectiontimeout-and-state-properties-example-vj.md)

  - [Count プロパティの使用例 (VJ++)](count-property-example-vj.md)

  - [CursorType プロパティ、LockType プロパティ、EditMode プロパティの使用例 (VJ++)](cursortype-locktype-and-editmode-properties-example-vj.md)

  - [Delete メソッドの使用例 (VJ++)](delete-method-example-vj.md)

  - [Description プロパティ、HelpContext プロパティ、HelpFile プロパティ、NativeError プロパティ、Number プロパティ、Source プロパティ、SQLState プロパティの使用例 (VJ++)](description-helpcontext-helpfile-nativeerror-number-source-and-sqlstate-properties-example-vj.md)

  - [Execute メソッド、Requery メソッド、Clear メソッドの使用例 (VJ++)](execute-requery-and-clear-methods-example-vj.md)
  ...
  - [Move メソッドの使用例 (VJ++)](move-method-example-vj.md)

  - [MoveFirst メソッド、MoveLast メソッド、MoveNext メソッド、MovePrevious メソッドの使用例 (VJ++)](movefirst-movelast-movenext-and-moveprevious-methods-example-vj.md)
  ...
  - [Open メソッドと Close メソッドの使用例 (VJ++)](open-and-close-methods-example-vj.md)
  ...
  - [Save メソッドと Open メソッドの使用例 (VJ++)](save-and-open-methods-example-vj.md)
  ...
  - [UpdateBatch メソッドと CancelBatch メソッドの使用例 (VJ++)](updatebatch-and-cancelbatch-methods-example-vj.md)

  - [Value プロパティの使用例 (VJ++)](value-property-example-vj.md)

  - [バージョン プロパティの使用例 (vj++)](version-property-example-vj.md)
