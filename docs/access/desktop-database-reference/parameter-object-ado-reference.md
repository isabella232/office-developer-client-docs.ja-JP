...
ms.locfileid: "32288106"
---
# <a name="parameter-object-ado-reference"></a>Parameter オブジェクト (ADO) リファレンス

**適用先:** Access 2013、Office 2013

- [Parameter オブジェクト (ADO)](parameter-object-ado.md)
- [Parameter のプロパティ、メソッド、およびイベント (ADO)](parameter-properties-methods-and-events-ado.md)
