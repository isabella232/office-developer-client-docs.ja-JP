...
---
# <a name="columns-collection-adox-reference"></a>列コレクション (ADOX) 参照

**適用されます**Access 2013、Office 2013。

- [Columns コレクション (ADOX)](columns-collection-adox.md)
- [列コレクションのプロパティ、メソッド、およびイベント (ADOX)](columns-collection-properties-methods-and-events-adox.md)
