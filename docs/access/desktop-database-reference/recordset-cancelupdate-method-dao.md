...
---
# <a name="recordsetcancelupdate-method-dao"></a>Recordset メソッド (DAO)
...
**Recordset**の**[EditMode](recordset-editmode-property-dao.md)** プロパティを調べて、取り消すことができる保留中の操作があるかどうかを確認します。
