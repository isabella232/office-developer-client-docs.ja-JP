...
<td><p>指定されたオブジェクトに対して SQL ステートメントを実行します。</p></td>
</tr>
<tr class="odd">
...
<td><p>指定した <strong><a href="parameters-collection-dao.md">QueryDef</a></strong> のすべての Parameter オブジェクトを含む <strong><a href="parameter-object-dao.md">Parameters</a></strong> コレクションを <strong>返します</strong>。 読み取り専用。</p></td>
</tr>
<tr class="even">
