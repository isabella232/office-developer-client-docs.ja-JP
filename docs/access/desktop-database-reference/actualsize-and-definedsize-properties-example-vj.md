...
ms.locfileid: "32281923"
---
# <a name="actualsize-and-definedsize-properties-example-vj"></a><span data-ttu-id="4d9db-102">ActualSize プロパティと DefinedSize プロパティの使用例 (VJ++)</span><span class="sxs-lookup"><span data-stu-id="4d9db-102">ActualSize and DefinedSize properties example (VJ++)</span></span>

<span data-ttu-id="4d9db-103">**適用先:** Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="4d9db-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="4d9db-104">This example uses the [ActualSize](actualsize-property-ado.md) and [DefinedSize](definedsize-property-ado.md) properties to display the defined size and actual size of a field.</span><span class="sxs-lookup"><span data-stu-id="4d9db-104">This example uses the [ActualSize](actualsize-property-ado.md) and [DefinedSize](definedsize-property-ado.md) properties to display the defined size and actual size of a field.</span></span>
