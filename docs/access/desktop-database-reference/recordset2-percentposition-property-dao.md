...
---
# <a name="recordset2percentposition-property-dao"></a>PercentPosition プロパティ (DAO)
...
> [!NOTE]
> **PercentPosition**プロパティを使用して、 **Recordset**オブジェクト内の特定のレコードにカレントレコードを移動することはお勧めしません。 **[Bookmark](recordset2-bookmark-property-dao.md)** プロパティを使用すると、このタスクにより適しています。
