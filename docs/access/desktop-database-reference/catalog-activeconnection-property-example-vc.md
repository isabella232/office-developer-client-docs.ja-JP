...
ms.locfileid: "32296599"
---
# <a name="catalog-activeconnection-property-example-vc"></a><span data-ttu-id="ac24d-102">Catalog の ActiveConnection プロパティの使用例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="ac24d-102">Catalog ActiveConnection property example (VC++)</span></span>


<span data-ttu-id="ac24d-103">**適用先:** Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="ac24d-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="ac24d-p101">[ActiveConnection](activeconnection-property-adox.md) プロパティを有効に設定すると、開いている接続によってカタログが開かれます。開いたカタログから、そのカタログ内に含まれているスキーマ オブジェクトにアクセスできます。</span><span class="sxs-lookup"><span data-stu-id="ac24d-p101">Setting the [ActiveConnection](activeconnection-property-adox.md) property to a valid, open connection "opens" the catalog. From an open catalog, you can access the schema objects contained within that catalog.</span></span>
