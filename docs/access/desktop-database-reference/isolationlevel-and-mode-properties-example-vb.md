...
ms.locfileid: "28722845"
---
# <a name="isolationlevel-and-mode-properties-example-vb"></a><span data-ttu-id="7a786-102">IsolationLevel プロパティと Mode プロパティの使用例 (VB)</span><span class="sxs-lookup"><span data-stu-id="7a786-102">IsolationLevel and Mode properties example (VB)</span></span>


<span data-ttu-id="7a786-103">**適用されます**Access 2013、Office 2013。</span><span class="sxs-lookup"><span data-stu-id="7a786-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="7a786-104">この例では、[Mode](mode-property-ado.md) プロパティを使って排他的接続を開き、 [IsolationLevel](isolationlevel-property-ado.md) プロパティを使って他のトランザクションから独立したトランザクションを開きます。</span><span class="sxs-lookup"><span data-stu-id="7a786-104">This example uses the [Mode](mode-property-ado.md) property to open an exclusive connection, and the [IsolationLevel](isolationlevel-property-ado.md) property to open a transaction that is conducted in isolation of other transactions.</span></span>
