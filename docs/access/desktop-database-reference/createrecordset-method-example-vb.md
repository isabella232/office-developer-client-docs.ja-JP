...
次のコード例では、**RDSServer.DataFactory** オブジェクトを使用した [Recordset](datafactory-object-rdsserver.md) の定義方法を示します。 [RDS.DataControl](datacontrol-object-rds.md) オブジェクトでも、同じように使用できます。
