---
title: Parameters コレクション、 Command プロパティの例 (VC++)
...
ms.locfileid: "59585523"
---
# <a name="parameters-collection-command-property-example-vc"></a>Parameters コレクション、 Command プロパティの例 (VC++)
