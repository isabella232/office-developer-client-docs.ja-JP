...
ms.locfileid: "32288814"
---
# <a name="move-method-example-vj"></a><span data-ttu-id="3315e-102">Move メソッドの使用例 (VJ++)</span><span class="sxs-lookup"><span data-stu-id="3315e-102">Move method example (VJ++)</span></span>


<span data-ttu-id="3315e-103">**適用先:** Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="3315e-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="3315e-104">次の例では、 [Move](move-method-ado.md) メソッドを使用して、ユーザーの入力に基づいてレコード ポインターの位置を決定します。</span><span class="sxs-lookup"><span data-stu-id="3315e-104">This example uses the [Move](move-method-ado.md) method to position the record pointer based on user input.</span></span>
