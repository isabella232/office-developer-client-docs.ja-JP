...
**LevelName** プロパティを使用して、メンバーが属しているレベルの名前を取得します。このプロパティは、 [Level](name-property-ado-md.md) オブジェクトの [Name](level-object-ado-md.md) プロパティに対応します。
