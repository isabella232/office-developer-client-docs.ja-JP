...
ms.locfileid: "32313616"
---
# <a name="update-and-cancelupdate-methods-example-vc"></a><span data-ttu-id="0835d-102">Update メソッドと CancelUpdate メソッドの使用例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="0835d-102">Update and CancelUpdate methods example (VC++)</span></span>


<span data-ttu-id="0835d-103">**適用先:** Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="0835d-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="0835d-104">次の例では、[Update](update-method-ado.md) メソッドと [CancelUpdate](cancelupdate-method-ado.md) メソッドを組み合わせて使用する方法を示します。</span><span class="sxs-lookup"><span data-stu-id="0835d-104">This example demonstrates the [Update](update-method-ado.md) method in conjunction with the [CancelUpdate](cancelupdate-method-ado.md) method.</span></span>
...
<span data-ttu-id="0835d-105">**updatex**</span><span class="sxs-lookup"><span data-stu-id="0835d-105">**UpdateX.h**</span></span>
