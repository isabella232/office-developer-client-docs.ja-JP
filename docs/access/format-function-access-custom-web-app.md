...
- [標準的な数値書式の文字列](http://msdn.microsoft.com/en-us/library/dwhawy9k%28v=vs.110%29.aspx)
    
- [カスタムの数値書式の文字列](http://msdn.microsoft.com/en-us/library/0c899ak8%28v=vs.110%29.aspx)
    
- [標準的な日付と時刻の形式の文字列](http://msdn.microsoft.com/en-us/library/az4se3k1%28v=vs.110%29.aspx)
    
- [カスタムの日付と時刻の形式の文字列](http://msdn.microsoft.com/en-us/library/8kb3ddd4%28v=vs.110%29.aspx)
