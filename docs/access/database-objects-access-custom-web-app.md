...
---
# <a name="database-objects-access-custom-web-app"></a>データベース オブジェクト (カスタム web アプリケーションのアクセス)
...
- [SetProperty マクロ アクション (カスタム web アプリケーションのアクセス)](setproperty-macro-action-access-custom-web-app.md)
