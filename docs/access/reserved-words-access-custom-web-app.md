...
---
# <a name="reserved-keywords-access-custom-web-app"></a>予約済みキーワード (カスタム web アプリケーションのアクセス)
...
|ELSE  <br/> |ORDER  <br/> |Week  <br/> |
|END  <br/> |OUTER  <br/> |Weekday  <br/> |
...
## <a name="odbc-reserved-keywords"></a>ODBC 予約済みキーワード
...
|実行  <br/> |MATCH  <br/> |TRAILING  <br/> |
|現在のユーザー  <br/> |MAX  <br/> |TRANSACTION  <br/> |
...
|CUME_DIST  <br/> |NEW  <br/> |TIMESTAMP  <br/> |
...
|DESCRIBE  <br/> |PARAMETERS  <br/> |VARCHAR  <br/> |
|DESCRIPTOR  <br/> |PARTIAL  <br/> |VARIABLE  <br/> |
|DESTROY  <br/> |PARTITION  <br/> |WHENEVER  <br/> |
|DESTRUCTOR  <br/> |PATH  <br/> |WIDTH_BUCKET  <br/> |
|DETERMINISTIC  <br/> |POSTFIX  <br/> |WITHOUT  <br/> |
