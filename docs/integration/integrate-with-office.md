...
クラウド ストレージ プロバイダーであれば、[パートナー プログラム](http://dev.office.com/programs/officecloudstorage)に登録することによって Office Online アプリと統合し、ユーザーがすべての Web ブラウザーで Excel、PowerPoint、および Word のドキュメントを表示し編集できるようにします。 
...
- [Office クライアント開発](https://msdn.microsoft.com/en-us/library/dn833103.aspx)
    
- [Office の開発](http://msdn.microsoft.com/library/7f24db34-c1ad-4a83-a9bd-3c85a39c0bd8%28Office.15%29.aspx)
