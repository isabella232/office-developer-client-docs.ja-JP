...
図形の影に使用するテーマの色を、0から7の整数で指定します。
  
|||
|:-----|:-----|
|値  <br/> |説明  <br/> |
|.0  <br/> |図形の影の色を、[ダーク] テーマの色から継承します。  <br/> |
|1-d  <br/> |図形の影の色を、[ライト] テーマの色から継承します。  <br/> |
|pbm-2  <br/> |図形の影の色を、[アクセント 1] テーマの色から継承します。  <br/> |
|1/3  <br/> |図形の影の色を、[アクセント 2] テーマの色から継承します。  <br/> |
|2/4  <br/> |図形の影の色を、[アクセント 3] テーマの色から継承します。  <br/> |
|5  <br/> |図形の影の色を、[アクセント 4] テーマの色から継承します。  <br/> |
|シックス  <br/> |図形の影の色を、[アクセント 5] テーマの色から継承します。  <br/> |
