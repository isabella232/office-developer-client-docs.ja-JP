...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[行要素 (レイヤー ・ セクション)](row-element-layer-sectionvisio-xml.md) <br/> |[LayerRow_Type](layerrow_type-complextypevisio-xml.md) <br/> |レイヤーの 1 つのプロパティ ページのプロパティを指定します。  <br/> |
...
|ロック  <br/> |レイヤーに属する図形に対する選択操作や編集操作をロックするかどうかを指定します。  <br/> |なし。  <br/> |
