...
図形の幅と高さに相対する、直線セグメントの最後の頂点に対する x 座標または y 座標を格納します。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[Row 要素 (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[RelLineTo_Type](rellineto_type-complextypevisio-xml.md) <br/> |図形の幅と高さに相対する、直線セグメントの最後の頂点に対する x 座標または y 座標を格納します。  <br/> |
...
|**値**|**説明**|**詳細情報**|
|:-----|:-----|:-----|
|X  <br/> |図形の幅を基準にした直線セグメントの終了頂点の x 座標。  <br/> |[RelLineTo 行 (Geometry セクション)](rellineto-row-geometry-section.md) <br/> |
|Y  <br/> |図形の高さを基準にした直線セグメントの終了頂点の y 座標。  <br/> |[RelLineTo 行 (Geometry セクション)](rellineto-row-geometry-section.md) <br/> |
