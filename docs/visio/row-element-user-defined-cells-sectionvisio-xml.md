...
|||
|:-----|:-----|
|**要素の型** <br/> |[UserRow_Type](userrow_type-complextypevisio-xml.md) <br/> |
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |ユーザーが指定した 1 つの情報を他のセルやアドオン ツールによって参照できます。  <br/> |
