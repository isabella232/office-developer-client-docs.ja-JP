...
---
# <a name="row-element-user-defined-cells-section-visio-xml"></a>Row 要素 (ユーザー定義セルセクション) (Visio XML)

他のセルとアドオンツールで参照できるユーザー指定の情報の一部。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |他のセルとアドオンツールで参照できるユーザー指定の情報の一部。  <br/> |
   
### <a name="child-elements"></a>子要素

|**Element**|**型**|**説明**|
|:-----|:-----|:-----|
|[Cell](cell-element-user-defined-cells-sectionvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |ユーザーが指定した一連の情報の1つのプロパティ。他のセルとアドオンツールで参照できます。  <br/> |
