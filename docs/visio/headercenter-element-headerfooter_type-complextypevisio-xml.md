...
ms.locfileid: "19805495"
---
# <a name="headercenter-element-headerfootertype-complextype-visio-xml"></a>HeaderCenter 要素 (HeaderFooter_Type complexType)'Visio XML (')

図面のヘッダーの中央の部分に表示されるテキスト文字列が含まれています。
