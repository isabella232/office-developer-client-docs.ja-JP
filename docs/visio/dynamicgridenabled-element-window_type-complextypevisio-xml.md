...
description: ウィンドウに対して動的グリッド機能を有効にするかどうかを指定します。
...
---
# <a name="dynamicgridenabled-element-window_type-complextype-visio-xml"></a>DynamicGridEnabled 要素 (Window_Type complexType) (Visio XML)

ウィンドウに対して動的グリッド機能を有効にするかどうかを指定します。
