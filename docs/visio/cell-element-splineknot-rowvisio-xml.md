...
---
# <a name="cell-element-splineknot-row-visio-xml"></a>セル要素 (SplineKnot 行) ('Visio XML')

X 座標または y 座標、スプラインの制御点、またはスプラインのノットが含まれています。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[行要素 (ジオメトリ)](row-element-geometry-sectionvisio-xml.md) <br/> |[SplineKot_Type](splineknot_type-complextypevisio-xml.md) <br/> |X 座標または y 座標、スプラインの制御点、またはスプラインのノットが含まれています。  <br/> |
...
|**値**|**説明**|**詳細については**|
|:-----|:-----|:-----|
|X  <br/> |コントロール ポイントの x 座標。  <br/> |[[SplineKnot] 行 ([Geometry] セクション)](splineknot-row-geometry-section.md) <br/> |
|Y  <br/> |コントロール ポイントの y 座標。  <br/> |[[SplineKnot] 行 ([Geometry] セクション)](splineknot-row-geometry-section.md) <br/> |
