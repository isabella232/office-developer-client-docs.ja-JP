...
セクションの [[グラデーションの分岐点] 行 ([線のグラデーション] セクション)](gradient-stop-row-line-gradient-section.md)行は、線のグラデーションの分岐点を表します。 このセクションは空にできます。 
...
図形のグラデーションの色を有効または無効にするには、 [[linegradientenabled] セル ([グラデーションのプロパティ] セクション)](linegradientenabled-cell-gradient-properties-section.md)セルの値を変更します。 
