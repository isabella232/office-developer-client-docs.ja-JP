...
---
# <a name="row-element-connection-section-visio-xml"></a>Row 要素 (接続セクション) (Visio XML)

図形上の1つの接続ポイントに対する x 座標または y 座標、水平方向と垂直方向、および種類を格納します。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |図形上の1つの接続ポイントに対する x 座標または y 座標、水平方向と垂直方向、および種類を格納します。  <br/> |
   
### <a name="child-elements"></a>子要素

|**Element**|**型**|**説明**|
|:-----|:-----|:-----|
|[Cell](cell-element-connection-rowvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |1つのプロパティを指定します。  <br/> |
