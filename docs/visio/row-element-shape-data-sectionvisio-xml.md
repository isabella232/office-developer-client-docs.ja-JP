...
---
# <a name="row-element-shape-data-section-visio-xml"></a>Row 要素 (Shape Data Section) (Visio XML)

データを図形に関連付けする 1 つの図形データ エントリを指定します。
  
## <a name="element-information"></a>要素の情報

|||
|:-----|:-----|
|**要素の種類** <br/> |[図形Data_Type](propertyrow_type-complextypevisio-xml.md) <br/> |
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |データを図形に関連付けする 1 つの図形データ エントリを指定します。  <br/> |
   
### <a name="child-elements"></a>子要素

|**Element**|**型**|**説明**|
|:-----|:-----|:-----|
|[Cell](cell-element-shape-data-sectionvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |図形データのいずれかのプロパティを指定します。  <br/> |
