...
無限線上の 2 つの点に対する x 座標または y 座標を格納します。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[Row 要素 (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[InfiniteLine_Type](infiniteline_type-complextypevisio-xml.md) <br/> |無限線上の 2 つの点に対する x 座標または y 座標を格納します。  <br/> |
