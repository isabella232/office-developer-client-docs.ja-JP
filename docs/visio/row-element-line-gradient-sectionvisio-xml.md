...
---
# <a name="row-element-line-gradient-section-visio-xml"></a>Row 要素 (線のグラデーションセクション) (Visio XML)
...
|**Element**|**型**|**説明**|
|:-----|:-----|:-----|
|[Cell](cell-element-line-gradient-sectionvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |1つのプロパティを指定します。  <br/> |
