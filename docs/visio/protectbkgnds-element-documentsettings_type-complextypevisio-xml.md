...
ms.locfileid: "25387651"
---
# <a name="protectbkgnds-element-documentsettingstype-complextype-visio-xml"></a>ProtectBkgnds 要素 (DocumentSettings_Type complexType)'Visio XML (')

削除したり、背景ページを編集ユーザーを禁止するかどうかを指定します。
