...
---
# <a name="cell-element-polylineto-row-visio-xml"></a>セル要素 ([polylineto] 行) ('Visio XML')

X 座標または y 座標ポリラインまたはポリラインの数式の最後の点が含まれています。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[行要素 (ジオメトリ)](row-element-geometry-sectionvisio-xml.md) <br/> |[PolylineTo_Type](polylineto_type-complextypevisio-xml.md) <br/> |X 座標または y 座標ポリラインまたはポリラインの数式の最後の点が含まれています。  <br/> |
...
|**値**|**説明**|**詳細については**|
|:-----|:-----|:-----|
|X  <br/> |ポリラインの終点の x 座標。  <br/> |[[PolylineTo] 行 ([Geometry] セクション)](polylineto-row-geometry-section.md) <br/> |
|Y  <br/> |ポリラインの終点の y 座標。  <br/> |[[PolylineTo] 行 ([Geometry] セクション)](polylineto-row-geometry-section.md) <br/> |
