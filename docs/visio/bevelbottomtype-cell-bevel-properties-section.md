...
名前によって**BevelBottomType** ] セルへの参照を取得、.vsdx ファイル形式での**セル**要素の**N**属性の値によって、別の数式または**CellsU**プロパティを使用したプログラムから、次のように使用します。 
  
|||
|:-----|:-----|
| セル名:  <br/> | BevelBottomType  <br/> |
   
プログラムから、インデックスによって [ **BevelBottomType** ] セルへの参照を取得するのには、次の引数を持つ**CellsSRC**プロパティを使用します。 
