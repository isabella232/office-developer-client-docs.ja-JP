...
など 45.635 ° を入力する場合 Visio は 45 ° 38' 6"と等価の値を表示します。
  
|**単位を指定するのには**|**この省略形を使用します。**|**オートメーション定数**|
|:-----|:-----|:-----|
...
|**指定する細分単位**|**この省略形を使用します。**|**オートメーション定数**|
|:-----|:-----|:-----|
...
|**指定する多次元単位**|**この省略形を使用します。**|**オートメーション定数**|
|:-----|:-----|:-----|
...
| _単位_ <br/> |_数_当初は表現する単位です。  <br/> |
| _フラグ_ <br/> |暗黙的単位で値を表示するときに使用する測定方法です。flag の値は次のとおりです。  <br/> |
...
|**visPageUnits** <br/> |**[ページ設定**] ダイアログ ボックスの [**ページ プロパティ**] タブに、[**単位**] ボックスで選択した単位 ([**デザイン**] タブで、矢印をクリック、 **[ページ設定**)。  <br/> |
|**visTypeUnits** <br/> |**Visio のオプション**] ダイアログ ボックスの [**詳細設定**] タブで、[**表示**] の**テキスト**ボックスで選択した単位 (、[**ファイル**] タブをクリックし、[**オプション**] をクリック) します。  <br/> |
|**visAngleUnits** <br/> |**Visio のオプション**] ダイアログ ボックスの [**詳細設定**] タブで、[**表示**] の**角度**ボックスで選択した単位です。  <br/> |
|**visDurationUnits** <br/> |**Visio のオプション**] ダイアログ ボックスの [**詳細設定**] タブで、[**表示**] の**継続時間**ボックスで選択した単位です。  <br/> |
