...
---
# <a name="cell-element-arcto-row-visio-xml"></a>セル要素 (ArcTo 行) ('Visio XML')

X を含む座標、y 座標、または円弧の弓。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[行要素 (ジオメトリ)](row-element-geometry-sectionvisio-xml.md) <br/> |[ArcTo_Type](arcto_type-complextypevisio-xml.md) <br/> |円弧の x 座標と y 座標、および弧を格納します。  <br/> |
   
### <a name="child-elements"></a>子要素

|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[RefBy](refby-element-cell_type-complextypevisio-xml.md) <br/> |[RefBy_Type](refby_type-complextypevisio-xml.md) <br/> |X を含む座標、y 座標、または円弧の弓。  <br/> |
...
|**値**|**説明**|**詳細情報**|
|:-----|:-----|:-----|
|A  <br/> |円弧の中点から弦の中点までの距離です。  <br/> |[[ArcTo] 行 ([Geometry] セクション)](arcto-row-geometry-section.md) <br/> |
|X  <br/> |円弧の最後の頂点に対する x 座標です。  <br/> |[[ArcTo] 行 ([Geometry] セクション)](arcto-row-geometry-section.md) <br/> |
|Y  <br/> |円弧の最後の頂点に対する y 座標です。  <br/> |[[ArcTo] 行 ([Geometry] セクション)](arcto-row-geometry-section.md) <br/> |
