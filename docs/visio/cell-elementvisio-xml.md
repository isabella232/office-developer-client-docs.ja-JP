...
|BeginArrow  <br/> |最初の頂点には、矢印やその他の書式の端点に 1 行かどうかを示します。 0 から 45 に番号を入力、または使用して機能のユーザー設定の線の端点では、名前の線] ダイアログ ボックスを使用します。  <br/> |[[BeginArrow] セル ([Line Format] セクション)](beginarrow-cell-line-format-section.md) <br/> |
...
|[Beginx]  <br/> |親の原点を基準として、1 次元図形の始点の x 座標を表します。 親の原点を基準として、1 次元図形の始点の x 座標を表します。  <br/> |[[BeginX] セル ([1-D Endpoints] セクション)](beginx-cell-1-d-endpoints-section.md) <br/> |
|[Beginy]  <br/> |親の原点を基準として、1 次元図形の始点の y 座標を表します。  <br/> |[[BeginY] セル ([1-D Endpoints] セクション)](beginy-cell-1-d-endpoints-section.md) <br/> |
...
|BevelBottomHeight  <br/> |ポイント単位での図形の下の面取りの高さを決定します。  <br/> |[BevelBottomHeight セル (傾斜面のプロパティ] セクションで)](bevelbottomheight-cell-bevel-properties-section.md) <br/> |
|BevelBottomType  <br/> |図形の傾斜面の下の面取りの種類を指定します。  <br/> |[BevelBottomType セル (傾斜面のプロパティ] セクションで)](bevelbottomtype-cell-bevel-properties-section.md) <br/> |
|BevelBottomWidth  <br/> |ポイントの下の面取りの幅を決定します。  <br/> |[BevelBottomWidth セル (傾斜面のプロパティ] セクションで)](bevelbottomwidth-cell-bevel-properties-section.md) <br/> |
|BevelContourColor  <br/> |ベベルの RGB 値の配分やテーマによって、決められた色を決定します。  <br/> |[BevelContourColor セル (傾斜面のプロパティ] セクションで)](bevelcontourcolor-cell-bevel-properties-section.md) <br/> |
|BevelContourSize  <br/> |傾斜面の輪郭をポイント単位でのサイズを決定します。  <br/> |[BevelContourSize セル (傾斜面のプロパティ] セクションで)](bevelcontoursize-cell-bevel-properties-section.md) <br/> |
|BevelDepthColor  <br/> |RGB 値として、またはアクティブなテーマでの面取りの奥行、色を決定します。  <br/> |[BevelDepthColor セル (傾斜面のプロパティ] セクションで)](beveldepthcolor-cell-bevel-properties-section.md) <br/> |
|BevelDepthSize  <br/> |傾斜面の深さをポイント単位でのサイズを決定します。  <br/> |[BevelDepthSize セル (傾斜面のプロパティ] セクションで)](beveldepthsize-cell-bevel-properties-section.md) <br/> |
|BevelLightingAngle  <br/> |度の傾斜面を基準にして稲妻の角度を決定します。  <br/> |[BevelLightingAngle セル (傾斜面のプロパティ] セクションで)](bevellightingangle-cell-bevel-properties-section.md) <br/> |
|BevelLightingType  <br/> |ベベル効果に使用する光源の種類を決定します。  <br/> |[BevelLightingType セル (傾斜面のプロパティ] セクションで)](bevellightingtype-cell-bevel-properties-section.md) <br/> |
|BevelMaterialType  <br/> |傾斜面で構成する材料のタイプを決定します。  <br/> |[BevelMaterialType セル (傾斜面のプロパティ] セクションで)](bevelmaterialtype-cell-bevel-properties-section.md) <br/> |
|BevelTopHeight  <br/> |ポイントで図形の上の面取りの高さを決定します。  <br/> |[BevelTopHeight セル (傾斜面のプロパティ] セクションで)](beveltopheight-cell-bevel-properties-section.md) <br/> |
|BevelTopType  <br/> |図形の上端の面取りの種類を決定します。  <br/> |[BevelTopType セル (傾斜面のプロパティ] セクションで)](beveltoptype-cell-bevel-properties-section.md) <br/> |
|BevelTopWidth  <br/> |ポイントの上の面取りの幅を決定します。  <br/> |[BevelTopWidth セル (傾斜面のプロパティ] セクションで)](beveltopwidth-cell-bevel-properties-section.md) <br/> |
...
|指定  <br/> |テキスト ブロックの下枠とそれに含まれるテキストの最後の行の間の距離を決定します。  <br/> |[[BottomMargin] セル ([Text Block Format] セクション)](bottommargin-cell-text-block-format-section.md) <br/> |
...
|カレンダー  <br/> |データ型が Date のとき図形データに使用するカレンダーを指定します。  <br/> |[[Calendar] セル ([Shape Data] セクション)](calendar-cell-shape-data-section.md) <br/> |
|カレンダー  <br/> |データ型が Date のときに、テキスト フィールドに使用するカレンダーを指定します。  <br/> |[[Calendar] セル ([Text Fields] セクション)](calendar-cell-text-fields-section.md) <br/> |
...
|ClippingPath  <br/> |イメージを限定しているパスの図形座標への参照を格納します。  <br/> |[ClippingPath セル (外部イメージ情報」セクション)](clippingpath-cell-foreign-image-info-section.md) <br/> |
|ColorSchemeIndex  <br/> |整数値で、図形に適用されているテーマの配色パターンを決定します。  <br/> |[ColorSchemeIndex セル ([プロパティ] セクションのテーマ)](colorschemeindex-cell-theme-properties-section.md) <br/> |
...
|CompoundType  <br/> |複合図形の線の種類を決定します。  <br/> |[CompoundType セル (行の書式セクション)](compoundtype-cell-line-format-section.md) <br/> |
...
|ConnectorSchemeIndex  <br/> |整数値で、図形に適用されているテーマのコネクタの設定を決定します。  <br/> |[ConnectorSchemeIndex セル ([プロパティ] セクションのテーマ)](connectorschemeindex-cell-theme-properties-section.md) <br/> |
...
|DisplayLevel  <br/> |図形の表示レベル バンド (Z オーダー グループ化の相対範囲) を指定します。  <br/> |[DisplayLevel セル ([図形のレイアウト] セクション)](displaylevel-cell-shape-layout-section.md) <br/> |
...
|DistanceFromGround  <br/> |オブジェクトに 3-D の回転時に地面から発生する距離を指定します。  <br/> |[DistanceFromGround セル (3-D の回転プロパティ)](distancefromground-cell-3-d-rotation-properties.md) <br/> |
...
|DrawingResizeType  <br/> |図に合わせて、図面ページが自動的にサイズ変更するかどうかを決定します。  <br/> |[DrawingResizeType セル ([ページ プロパティ] セクションで)](drawingresizetype-cell-page-properties-section.md) <br/> |
...
|DrawingScaleType  <br/> |[ページ設定] ダイアログ ボックスで選択した図面の縮尺を指定 ([ホーム] タブの [ページ設定の矢印] をクリック) します。  <br/> |[[DrawingScaleType] セル ([Page Properties] セクション)](drawingscaletype-cell-page-properties-section.md) <br/> |
...
|EffectSchemeIndex  <br/> |整数値で、図形に適用するテーマの効果設定を決定します。  <br/> |[EffectSchemeIndex セル ([プロパティ] セクションのテーマ)](effectschemeindex-cell-theme-properties-section.md) <br/> |
|EmbellishmentIndex  <br/> |コールアウト、コンテナー、タイムライン、および組織図の図形の外観と動作 (装飾) を変更します。  <br/> |[EmbellishmentIndex セル ([プロパティ] セクションのテーマ)](embellishmentindex-cell-theme-properties-section.md) <br/> |
...
|[Endx]  <br/> |親の原点を基準として、1 次元図形の終点の x 座標を表します。  <br/> |[[EndX] セル ([1-D Endpoints] セクション)](endx-cell-1-d-endpoints-section.md) <br/> |
|[Endy]  <br/> |親の原点を基準として、1 次元図形の終点の y 座標を表します。  <br/> |[[EndY] セル ([1-D Endpoints] セクション)](http://msdn.microsoft.com/library/3fbfa4bc-7792-b6d9-d549-4602d252c293"%28Office.15%29.aspx) <br/> |
...
|GlowColor  <br/> |図形に適用する外側のグローのストロークに使用する色を、RGB またはテーマの値で決定します。  <br/> |[GlowColor セル ([プロパティ] セクションの他の効果)](glowcolor-cell-additional-effect-properties-section.md) <br/> |
|GlowColorTrans  <br/> |パーセントでの図形の光彩、線の色の透過性レベルを決定します。  <br/> |[GlowColorTrans セル ([プロパティ] セクションの他の効果)](glowcolortrans-cell-additional-effect-properties-section.md) <br/> |
|GlowSize  <br/> |ポイントで図形の外部の光彩のサイズを決定します。  <br/> |[GlowSize セル ([プロパティ] セクションの他の効果)](http://msdn.microsoft.com/library/2ddc7a08-25b8-4903-b0dd-be72d1fa8075"%28Office.15%29.aspx) <br/> |
...
|KeepTextFlat  <br/> |図形のテキストが 3-d 図形の回転を無視するかどうかを示します。 2 次元の回転には適用されません。  <br/> |[KeepTextFlat セル ([3-D 回転オプション プロパティ] セクションで)](keeptextflat-cell-3-d-rotation-properties-section.md) <br/> |
...
|左マージン  <br/> |テキスト ブロックの左枠とテキストの間の距離を決定します。  <br/> |[[LeftMargin] セル ([Text Block Format] セクション)](leftmargin-cell-text-block-format-section.md) <br/> |
...
|[Lockcrop]  <br/> |トリミング ツールでトリミングされている別のプログラムからオブジェクトをロックします。  <br/> |[[LockCrop] セル ([Protection] セクション)](lockcrop-cell-protection-section.md) <br/> |
|LockCustProp  <br/> |かどうかユーザーを追加、削除、したり、[図形データ] ウィンドウの [図形データの定義] ダイアログ ボックスまたはショート カット メニューを使用してユーザー インターフェイス (UI) 内の図形データの変更を決定します。  <br/> |[[LockCustProp] セル ([Protection] セクション)](lockcustprop-cell-protection-section.md) <br/> |
...
|LockFromGroupFormat  <br/> |フォーマットを変更してグループ図形を直接選択したサブ図形の書式を設定するユーザーを許可する一方、サブ図形に反映されません。 LockFromGroupFormat セルの値は、[保護] ダイアログ ボックスでチェック ボックスの設定を書式設定のグループに対応しています。  <br/> |[LockFromGroupFormat セル (セクションの保護)](lockfromgroupformat-cell-protection-section.md) <br/> |
...
|LockReplace  <br/> |図形を置換操作に使用できるかどうか (ターゲット図形または置換後の図形のいずれかとして) を示します。  <br/> |[LockReplace セル (セクションの保護)](lockreplace-cell-protection-section.md) <br/> |
|LockRotate  <br/> |回転ハンドル、[左に 90 度回転で回転する 2 次元図形をロック 90 ° または 90 ° のコマンドを右 90 度回転します。  <br/> |[[LockRotate] セル ([Protection] セクション)](lockrotate-cell-protection-section.md) <br/> |
...
|LockThemeColors  <br/> |図形には、テーマの色のアプリケーションを防止します。 LockThemeColors セルの値は、保護] ダイアログ ボックスでのテーマの色のチェック ボックスの設定に対応します。  <br/> |[LockThemeColors セル (セクションの保護)](lockthemecolors-cell-protection-section.md) <br/> |
|LockThemeConnectors  <br/> |ConnectorsSchemeIndex、テーマのプロパティの行のセルが、新しいテーマを適用するか、新しいコネクタの設定を選択すると変更するを防ぎます。 でも、ユーザーからシェイプ シート内でこの値を手動で編集します。  <br/> |[LockThemeConnectors セル (セクションの保護)](lockthemeconnectors-cell-protection-section.md) <br/> |
|LockThemeEffects  <br/> |保護] ダイアログ ボックスでのテーマの効果のチェック ボックスの設定に対応します。  <br/> |[LockThemeEffects セル (セクションの保護)](lockthemeeffects-cell-protection-section.md) <br/> |
|LockThemeFonts  <br/> |FontIndex、テーマのプロパティの行のセルが新しいテーマを適用することによって変更するを防ぎます。 でも、ユーザーからシェイプ シート内でこの値を手動で編集します。  <br/> |[LockThemeFonts セル (セクションの保護)](lockthemefonts-cell-protection-section.md) <br/> |
|LockThemeIndex  <br/> |新しいテーマを適用するか、新しいコネクタの設定を選択することによって変更されているテーマのプロパティの行のセルを ThemeIndex できないようにします。 でも、ユーザーからシェイプ シート内でこの値を手動で編集します。  <br/> |[LockThemeIndex セル (セクションの保護)](lockthemeindex-cell-protection-section.md) <br/> |
|LockVariation  <br/> |ページまたは図形に適用するテーマのバリエーションを変更できるかどうかを、ブール演算型で決定します。  <br/> |[LockVariation セル (セクションの保護)](lockvariation-cell-protection-section.md) <br/> |
...
|[Objtype]  <br/> |オブジェクトを判断するかどうか配置可能なまたは図でルーティング可能な図形をレイアウトするのには、[レイアウトの構成] ダイアログ ボックスを使用するとします。  <br/> |[[ObjType] セル ([Miscellaneous] セクション)](objtype-cell-miscellaneous-section.md) <br/> |
|[Onpage]  <br/> |特定のプリンター ページ番号に図面を印刷するかどうかを示します。  <br/> |[[OnPage] セル ([Print Properties] セクション)](onpage-cell-print-properties-section.md) <br/> |
|そうです。  <br/> |図面の出力形式を指定します。図面ページは、通常は印刷用に形式が設定されていますが (既定値)、他の出力形式を選択することもできます。  <br/> |[[OutputFormat] セル ([Document Properties] セクション)](outputformat-cell-document-properties-section.md) <br/> |
...
|PageLockDuplicate  <br/> |ページを複製できるかどうかを、ブール演算型で決定します。  <br/> |[PageLockDuplicate セル ([ページ プロパティ] セクションで)](pagelockduplicate-cell-page-properties-section.md) <br/> |
|PageLockReplace  <br/> |このページの図形の置換] ボタンを無効にする必要があるかどうかを示します。  <br/> |[PageLockReplace セル ([ページ プロパティ] セクションで)](pagelockreplace-cell-page-properties-section.md) <br/> |
...
|パースペクティブ  <br/> |度 (0 359.9) で、面内の回転の遠近の角度を決定します。  <br/> |[分析観点のセル ([3-D 回転オプション プロパティ] セクションで)](perspective-cell-3-d-rotation-properties-section.md) <br/> |
|[Pinx]  <br/> |親の原点を基準として、図形の pin (回転の中心) の x 座標を表します。  <br/> |[[PinX] セル ([Shape Transform] セクション)](pinx-cell-shape-transform-section.md) <br/> |
|[Piny]  <br/> |親の原点を基準として、図形の pin (回転の中心) の y 座標を表します。  <br/> |[[PinY] セル ([Shape Transform] セクション)](piny-cell-shape-transform-section.md) <br/> |
...
|PlaceFlip  <br/> |どのように配置可能な図形を指定する反転または回転して、ページ レイアウトの構成] ダイアログ ボックスを使用する場合 ([デザイン] タブの [レイアウト] で、再レイアウト] ページをクリックし、他のレイアウト オプションをクリックし、)。  <br/> |[[PlaceFlip] セル ([Page Layout] セクション)](placeflip-cell-page-layout-section.md) <br/> |
|PlaceStyle  <br/> |図形の配置方法、ページをレイアウトする図形で、[レイアウトの構成] ダイアログ ボックスを使用するときを決定する ([デザイン] タブの [レイアウト] で、再レイアウト] ページをクリックし、他のレイアウト オプションをクリックし、)。  <br/> |[PlaceStyle セル ([ページ レイアウト] セクション)](placestyle-cell-page-layout-section.md) <br/> |
...
|ReflectionBlur  <br/> |0.0 から 100.0 までのポイント単位で、図形上の反射のぼかしの量を決定します。  <br/> |[ReflectionBlur セル ([プロパティ] セクションの他の効果)](reflectionblur-cell-additional-effect-properties-section.md) <br/> |
|ReflectionDist  <br/> |距離の決定に 100.0 0.0 からポイントに、図形から反射をオフセットします。  <br/> |[ReflectionDist セル ([プロパティ] セクションの他の効果)](reflectiondist-cell-additional-effect-properties-section.md) <br/> |
|ReflectionSize  <br/> |0.0 から 100.0% の割合として、図形を基準にして反射のサイズを決定します。 ReflectionSize のセルに 0% の値を持つ図形には、リフレクションはありません。100% の値は、図形の完全なミラー イメージを表示します。  <br/> |[ReflectionSize セル ([プロパティ] セクションの他の効果)](reflectionsize-cell-additional-effect-properties-section.md) <br/> |
|ReflectionTrans  <br/> |0 から 100% の割合として、反射の透明度を決定します。  <br/> |[ReflectionTrans セル ([プロパティ] セクションの他の効果)](reflectiontrans-cell-additional-effect-properties-section.md) <br/> |
|リレーションシップ  <br/> |コンテナー、リスト、引き出し、および図形どうしの関係を格納します。  <br/> |[関係セル ([図形のレイアウト] セクション)](relationships-cell-shape-layout-section.md) <br/> |
|ReplaceCopyCells  <br/> |図形の置換操作中に、古い図形から置換後の図形にコピーされるシェイプシート内のセル一覧を示します。  <br/> |[ReplaceCopyCells セル (変更の図形の動作セクション)](replacecopycells-cell-change-shape-behavior-section.md) <br/> |
|ReplaceLockFormat  <br/> |マスター シェイプ内の指定したセルの値が図形の置換操作の実行中に置換される図形の値 (ローカル値を含む) を上書きするかどうかを示します。 マスター シェイプの ReplaceLockFormat セルは、(1) は、TRUE に設定されている場合、マスター シェイプの書式設定の値はマスターによって置換される図形のすべてに対応する値を上書きします。  <br/> |[ReplaceLockFormat セル (変更の図形の動作セクション)](replacelockformat-cell-change-shape-behavior-section.md) <br/> |
|ReplaceLockShapeData  <br/> |マスター シェイプ内の指定したセルの値が図形の置換操作の実行中に置換される図形の値 (ローカル値を含む) を上書きするかどうかを示します。 ReplaceLockShapeData は、マスター シェイプの図形データが置換される図形の図形データのすべてを上書きしているかどうかを決定します。  <br/> |[ReplaceLockShapeData セル (変更の図形の動作セクション)](replacelockshapedata-cell-change-shape-behavior-section.md) <br/> |
|ReplaceLockText  <br/> |マスター シェイプ内の指定したセルの値が図形の置換操作の実行中に置換される図形の値 (ローカル値を含む) を上書きするかどうかを示します。 ReplaceLockText は、マスター上に表示されるテキストが置換される図形のテキストを上書きするかどうかを決定します。  <br/> |[ReplaceLockText セル (変更の図形の動作セクション)](replacelocktext-cell-change-shape-behavior-section.md) <br/> |
...
|ResizePage  <br/> |レイアウトの構成] ダイアログ ボックスを使用して図形をレイアウトした後で、図面ページを拡大するかどうか ([デザイン] タブの [レイアウト] で、再レイアウト] ページをクリックし、他のレイアウト オプションをクリックし、)。  <br/> |[[ResizePage] セル ([Page Layout] セクション)](resizepage-cell-page-layout-section.md) <br/> |
|右マージン  <br/> |テキスト ブロックの右の枠線と、そのブロックに含まれるテキストとの間隔を指定します。既定値は 0.1 インチです。  <br/> |[[RightMargin] セル ([Text Block Format] セクション)](rightmargin-cell-text-block-format-section.md) <br/> |
...
|RotationType  <br/> |図形が並行回転、視点回転、または斜め回転に従って回転するかどうかを、0 から 6 までの整数で決定します。  <br/> |[RotationType セル ([3-D 回転オプション プロパティ] セクションで)](rotationtype-cell-3-d-rotation-properties-section.md) <br/> |
|RotationXAngle  <br/> |度単位で、x 軸方向の回転の角度を設定 (0.0 から 359.9)。  <br/> |[RotationXAngle セル ([3-D 回転オプション プロパティ] セクションで)](rotationxangle-cell-3-d-rotation-properties-section.md) <br/> |
|RotationYAngle  <br/> |度単位で、y 軸方向の回転の角度を設定 (0.0 から 359.9)。  <br/> |[RotationYAngle セル ([3-D 回転オプション プロパティ] セクションで)](rotationyangle-cell-3-d-rotation-properties-section.md) <br/> |
|RotationZAngle  <br/> |度で、z 軸に沿った回転の角度を設定 (0.0 から 359.9)。  <br/> |[RotationZAngle セル ([3-D 回転オプション プロパティ] セクションで)](rotationzangle-cell-3-d-rotation-properties-section.md) <br/> |
...
|ShapePermeablePlace  <br/> |レイアウトの構成] ダイアログ ボックス内の図形をレイアウトするとき、配置可能な図形を図形の上に配置できるかどうかを決定する ([デザイン] タブの [レイアウト] で、再レイアウト] ページをクリックし、他のレイアウト オプションをクリックし、)。  <br/> |[[ShapePermeablePlace] セル ([Shape Layout] セクション)](shapepermeableplace-cell-shape-layout-section.md) <br/> |
...
|ShapePlaceFlip  <br/> |配置可能な図形を反転する方法を決定する、回転、またはその両方でページをレイアウトする図形で、[レイアウトの構成] ダイアログ ボックスを使用する場合 ([デザイン] タブの [レイアウト] で、再レイアウト] ページをクリックし、他のレイアウト オプションをクリックし、)。  <br/> |[[ShapePlaceFlip] セル ([Shape Layout] セクション)](shapeplaceflip-cell-shape-layout-section.md) <br/> |
|ShapePlaceStyle  <br/> |図形の配置方法のページで、[レイアウトの構成] ダイアログ ボックスをオンにして図形をレイアウトするときを指定する ([デザイン] タブの [レイアウト] で、再レイアウト] ページをクリックし、他のレイアウト オプションをクリックし、)。 VisCellIndices からレイアウト スタイルと整列の値を格納します。  <br/> |[ShapePlaceStyle セル ([図形のレイアウト] セクション)](shapeplacestyle-cell-shape-layout-section.md) <br/> |
...
|ShapeShdwBlur  <br/> |(0.00 ~ 100.00 の範囲) をポイント単位での図形の影のぼかしのサイズを決定します。  <br/> |[ShapeShdwBlur セル (塗りつぶしの書式設定])](shapeshdwblur-cell-fill-format-section.md) <br/> |
...
|ShapeShdwShow  <br/> |図形に影を表示するかどうかを、0 から 2 の整数で決定します。  <br/> |[ShapeShdwShow セル (塗りつぶしの書式設定])](shapeshdwshow-cell-fill-format-section.md) <br/> |
...
|SketchAmount  <br/> |スケッチ効果に対するゆがみの量を、0 から 25 の整数で決定します。  <br/> |[SketchAmount セル ([プロパティ] セクションの他の効果)](sketchamount-cell-additional-effect-properties-section.md) <br/> |
|SketchEnabled  <br/> |図形の上またはブール値としてではなく、スケッチ効果が表示されるかどうかを決定します。  <br/> |[SketchEnabled セル ([プロパティ] セクションの他の効果)](sketchenabled-cell-additional-effect-properties-section.md) <br/> |
|SketchFillChange  <br/> |セクションの長さの割合として、スケッチ効果を使用する場合は、図形の塗りつぶしを図形の座標からのランダム化の量を決定します。 SketchFillChange セルの値を 0% に設定すると、図形の塗りつぶしの境界のジオメトリは、図形の座標を一致します。 値が 100% の場合は、図形の塗りつぶしの境界のジオメトリは、図形のジオメトリを従っていません。  <br/> |[SketchFillChange セル ([プロパティ] セクションの他の効果)](sketchfillchange-cell-additional-effect-properties-section.md) <br/> |
|SketchLineChange  <br/> |セクションの長さの割合として、スケッチ効果を使用する場合は、図形の線を図形の座標からのランダム化の量を決定します。 SketchLineChange セルの値を 0% に設定すると、図形の線のジオメトリは、図形の座標を一致します。 値が 100% の場合は、図形の線のジオメトリは、図形のジオメトリを従っていません。  <br/> |[SketchLineChange セル ([プロパティ] セクションの他の効果)](sketchlinechange-cell-additional-effect-properties-section.md) <br/> |
|SketchLineWeight  <br/> |0 から 50 までのポイントで、スケッチ効果の結果として、線の太さに追加されたその他の太さを決定します。 セルが増加する SketchLineWeight の値として図形の線の太さが大きくなります。  <br/> |[SketchLineWeight セル ([プロパティ] セクションの他の効果)](sketchlineweight-cell-additional-effect-properties-section.md) <br/> |
|SketchSeed  <br/> |正の整数として、スケッチ効果のジオメトリを決定するためのランダム化の値を表します。 スケッチ効果が図形に適用すると、SketchSeed のセルの値がランダムに作成されます。  <br/> |[SketchSeed セル ([プロパティ] セクションの他の効果)](sketchseed-cell-additional-effect-properties-section.md) <br/> |
|SoftEdgesSize  <br/> |100.00 0.00 からポイントで、ソフト エッジ効果のサイズを決定します。 SoftEdgesSize セルの値が 0 の場合は、図形にはぼかしはありません。  <br/> |[SoftEdgesSize セル ([プロパティ] セクションの他の効果)](softedgessize-cell-additional-effect-properties-section.md) <br/> |
...
|ThemeIndex  <br/> |整数として、ドキュメントに適用される組み込みの Microsoft Visio のテーマの列挙体を格納します。 ドキュメントの新しいテーマを選択すると、組み込みのテーマのインデックスを使用してドキュメントとすべてのページと図形が含まれているの ThemeIndex のセルが更新されます。  <br/> |[ThemeIndex セル ([プロパティ] セクションのテーマ)](themeindex-cell-theme-properties-section.md) <br/> |
...
|[Txtangle]  <br/> |テキスト ブロックの現在の図形の x 軸を基準にして回転角度を決定します。 既定値は、0 度です。  <br/> |[[TxtAngle] セル ([Text Transform] セクション)](txtangle-cell-text-transform-section.md) <br/> |
...
|UseGroupGradient  <br/> |ブール値として、他の図形と図形がグループ化されたときに図形のグラデーションにされるかどうかを決定します。 UseGroupGradient のセルの値は、図形の塗りつぶしのみに影響します。  <br/> |[UseGroupGradient セル (グラデーションのプロパティ] セクション)](usegroupgradient-cell-gradient-properties-section.md) <br/> |
|VariationColorIndex  <br/> |整数値としてページで、アクティブなテーマのバリエーションの色のインデックスを決定します。  <br/> |[VariationColorIndex セル ([プロパティ] セクションのテーマ)](variationcolorindex-cell-theme-properties-section.md) <br/> |
|VariationStyleIndex  <br/> |整数値としてページで、アクティブなテーマのバリエーションのスタイルのインデックスを決定します。  <br/> |[VariationStyleIndex セル ([プロパティ] セクションのテーマ)](variationstyleindex-cell-theme-properties-section.md) <br/> |
...
|XRulerOrigin  <br/> |ページの x 軸のルーラーのゼロ点を指定します。  <br/> |[XRulerOrigin セル (ルーラー&amp;グリッド セクション)](xrulerorigin-cell-rulergrid-section.md) <br/> |
...
|YRulerOrigin  <br/> |ページの y 軸のルーラーのゼロ点を指定します。  <br/> |[YRulerOrigin セル (ルーラー&amp;グリッド セクション)](yrulerorigin-cell-rulergrid-section.md) <br/> |
