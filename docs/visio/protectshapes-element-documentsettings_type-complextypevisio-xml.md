...
---
# <a name="protectshapes-element-documentsettingstype-complextype-visio-xml"></a>ProtectShapes 要素 (DocumentSettings_Type complexType)'Visio XML (')

ユーザーがその**lockselect] を有効**要素を 1 に設定されている図形を選択できないとしているかどうかを指定します。 
