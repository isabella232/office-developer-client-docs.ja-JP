...
---
# <a name="row-element-fill-gradient-section-visio-xml"></a>Row 要素 (塗りつぶしのグラデーションセクション) (Visio XML)
...
|**Element**|**型**|**説明**|
|:-----|:-----|:-----|
|[Cell](cell-element-fill-gradient-sectionvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |1つのプロパティを指定します。  <br/> |
