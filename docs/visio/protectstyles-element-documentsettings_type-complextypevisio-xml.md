...
description: ユーザーがスタイルの作成または編集を妨げるかどうかを指定します。
ms.openlocfilehash: 088d010ed3bca0585b5e5cd4fcbbfdbeae84f4f0
ms.sourcegitcommit: a1d9041c20256616c9c183f7d1049142a7ac6991
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59570310"
---
# <a name="protectstyles-element-documentsettings_type-complextype-visio-xml"></a>ProtectStyles 要素 (DocumentSettings_Type complexType) (Visio XML)

ユーザーがスタイルの作成または編集を妨げるかどうかを指定します。
