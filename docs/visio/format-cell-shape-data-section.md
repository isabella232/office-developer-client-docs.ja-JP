...
| 固定リスト  <br/> | 1-d  <br/> | リストに表示する項目をセミコロンで区切って指定します。  <br/> |
| 番号  <br/> | pbm-2  <br/> | データの種類に適した書式形式を指定します。  <br/> |
| 可変リスト  <br/> | 2/4  <br/> | リストに表示する項目をセミコロンで区切って指定します。  <br/> |
| 日付/時刻  <br/> | 5  <br/> | データの種類に適した書式形式を指定します。  <br/> |
| 期間  <br/> | シックス  <br/> | データの種類に適した書式形式を指定します。  <br/> |
...
|||
|:-----|:-----|
| セル名:  <br/> | 提案. *名前*です。Prop の形式を指定します。 *name*には、行の名前を指定します。  <br/> |
