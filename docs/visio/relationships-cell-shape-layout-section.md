...
|**最初のパラメーター**|**追加パラメーター**|
|:-----|:-----|
|1-d  <br/> |このコンテナーのメンバーである図形。  <br/> |
|pbm-2  <br/> |このリストのメンバーである図形。  <br/> |
|1/3  <br/> |この図形に関連付けられた引き出し。  <br/> |
|2/4  <br/> |この図形がメンバーとして属しているコンテナー。  <br/> |
|5  <br/> |このリスト項目がメンバーとして属しているリスト。  <br/> |
|シックス  <br/> |この引き出しに関連付けられた図形。  <br/> |
|7  <br/> |この図形が配置されている左端のコンテナー。  <br/> |
|~  <br/> |この図形が配置されている右端のコンテナー。  <br/> |
|i-9  <br/> |この図形が配置されている上端のコンテナー。  <br/> |
|個  <br/> |この図形が配置されている下端のコンテナー。  <br/> |
|#  <br/> |このリストが重なっているリスト。  <br/> |
