...
図面のヘッダーの右側の部分に表示されるテキスト文字列が含まれています。
  
## <a name="element-information"></a>要素情報

|||
|:-----|:-----|
|**要素の型** <br/> |[HeaderRight_Type](headerright_type-complextypevisio-xml.md) <br/> |
