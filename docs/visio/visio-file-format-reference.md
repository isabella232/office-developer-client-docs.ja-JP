...
このリファレンスには、Visio ファイル形式 (\*.vsdx) のソリューションを開発するための例を含む、概念情報トピックと参照トピックが含まれています。
  
このコンテンツに関する質問やコメントをお送りください。 [docthis@microsoft.com](mailto:docthis@microsoft.com) 宛にフィードバックを送信できます。
  
 **初版**: 2012 年 10 月 | **更新**: 2013 年 3 月
...
- [スキーママップ](schema-mapvisio-xml.md): Visio ファイル形式の XML スキーマが表示されます。
