...
ms.locfileid: "59573552"
---
# <a name="rel-element-solution_type-complextype-visio-xml"></a>Rel 要素 (Solution_Type complexType) (Visio XML)

このソリューションに関連付けられたソリューション XML を持つパーツとの関係を指定します。
