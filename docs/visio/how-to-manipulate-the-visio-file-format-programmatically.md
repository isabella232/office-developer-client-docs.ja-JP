...
|[<span data-ttu-id="ae1e5-133">オープンなパッケージング規則の基礎</span><span class="sxs-lookup"><span data-stu-id="ae1e5-133">Essentials of the Open Packaging Conventions</span></span>](http://msdn.microsoft.com/ja-jp/library/ee361919.aspx) <br/> [<span data-ttu-id="ae1e5-134">Office (2007) オープン XML ファイル形式の概要</span><span class="sxs-lookup"><span data-stu-id="ae1e5-134">Introducing the Office (2007) Open XML File Formats</span></span>](http://msdn.microsoft.com/ja-jp/library/aa338205.aspx) <br/> |<span data-ttu-id="ae1e5-135">これら 2 つの資料では、Microsoft Office ファイルを開くのパッケージ化の規則を適用されている方法について説明します。</span><span class="sxs-lookup"><span data-stu-id="ae1e5-135">These two articles discuss how the Open Packaging Conventions have been applied to Microsoft Office files.</span></span> <span data-ttu-id="ae1e5-136">関係のパッケージでの作業し、いくつかのコード サンプルも含まれての説明が含まれます。</span><span class="sxs-lookup"><span data-stu-id="ae1e5-136">They contain descriptions of how relationships work in a package and also include some code examples.</span></span>  <br/> |
...
- [<span data-ttu-id="ae1e5-358">Visio デベロッパー センター</span><span class="sxs-lookup"><span data-stu-id="ae1e5-358">Visio Developer Center</span></span>](http://msdn.microsoft.com/ja-jp/office/aa905478.aspx)
    
- [<span data-ttu-id="ae1e5-359">Office オープン XML 形式のドキュメントを操作します。</span><span class="sxs-lookup"><span data-stu-id="ae1e5-359">Manipulate Office Open XML Formats Documents</span></span>](http://msdn.microsoft.com/ja-jp/library/aa982683%28v=office.12%29.aspx)
    
- [<span data-ttu-id="ae1e5-360">名前空間 (C#) (LINQ to XML) ドキュメントを作成します。</span><span class="sxs-lookup"><span data-stu-id="ae1e5-360">Create a Document with Namespaces (C#) (LINQ to XML)</span></span>](http://msdn.microsoft.com/ja-jp/library/bb387075.aspx)
    
- [<span data-ttu-id="ae1e5-361">Microsoft Office を起動することがなく、ドキュメントにカスタム XML 部分を追加します。</span><span class="sxs-lookup"><span data-stu-id="ae1e5-361">Add Custom XML Parts to Documents Without Starting Microsoft Office</span></span>](http://msdn.microsoft.com/ja-jp/library/bb608597%28VS.90%29.aspx)
