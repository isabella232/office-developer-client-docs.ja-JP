...
|NoQuickDrag  <br/> |図形の選択またはユーザーは、[Geometry] セクションで定義されている塗りつぶしの領域をクリックしたときにドラッグするかどうかを決定します。  <br/> |[[NoQuickDrag] セル ([図形座標] セクション)](noquickdrag-cell-geometry-section.md) <br/> |
