...
楕円の中心点および楕円上の 2 つの点に対する x 座標または y 座標を格納します。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[Row 要素 (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[Ellipse_Type](ellipse_type-complextypevisio-xml.md) <br/> |楕円の中心点および楕円上の 2 つの点に対する x 座標または y 座標を格納します。  <br/> |
...
|A  <br/> |楕円上の最初の点の x 座標。B セルで表される y 座標と組み合わせ。  <br/> |[[Ellipse] 行 ([Geometry] セクション)](ellipse-row-geometry-section.md) <br/> |
|B  <br/> |楕円の最初の点の y 座標。セルで表される x 座標と組み合わせ。  <br/> |[[Ellipse] 行 ([Geometry] セクション)](ellipse-row-geometry-section.md) <br/> |
|C  <br/> |楕円上の 2 番目の点の x 座標。D セルで表される y 座標と組み合わせ。  <br/> |[[Ellipse] 行 ([Geometry] セクション)](ellipse-row-geometry-section.md) <br/> |
|D  <br/> |楕円上の 2 番目の点の y 座標。C セルで表される y 座標と組み合わせ。  <br/> |[[Ellipse] 行 ([Geometry] セクション)](ellipse-row-geometry-section.md) <br/> |
