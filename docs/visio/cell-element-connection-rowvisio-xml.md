...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[行要素 ([接続] セクション)](row-element-connection-sectionvisio-xml.md) <br/> |[ConnectionRow_Type](connectionrow_type-complextypevisio-xml.md) <br/> |X 座標と y 座標、水平方向と垂直方向、および図形上の 1 つの接続ポイントの型が含まれています。  <br/> |
...
|Prompt  <br/> |この属性は、将来使用するために予約されています。  <br/> |なし。  <br/> |
|種類  <br/> |接続ポイントの種類を指定します。  <br/> |[[Type / C] セル ([Connection Points] セクション)](typec-cell-connection-points-section.md) <br/> |
|X  <br/> |ローカル座標での接続ポイントの x 座標を表します。  <br/> |[[X] セル ([Connection Points] セクション)](x-cell-connection-points-section.md) <br/> |
