...
---
# <a name="cell-element-user-defined-cells-section-visio-xml"></a>Cell 要素 ([ユーザー定義セル] セクション) (' Visio XML ')

ユーザーが指定した一連の情報の1つのプロパティ。他のセルとアドオンツールで参照できます。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[Row 要素 (ユーザー定義セルセクション)](row-element-user-defined-cells-sectionvisio-xml.md) <br/> |[UserRow_Type](userrow_type-complextypevisio-xml.md) <br/> |ユーザーが指定した一連の情報の1つのプロパティ。他のセルとアドオンツールで参照できます。  <br/> |
