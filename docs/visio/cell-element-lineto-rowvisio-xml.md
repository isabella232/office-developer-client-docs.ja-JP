...
---
# <a name="cell-element-lineto-row-visio-xml"></a>Cell 要素 ([LineTo] 行) (' Visio XML ')

直線セグメントの最後の頂点に対する x 座標または y 座標を格納します。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[Row 要素 (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[LineTo_Type](lineto_type-complextypevisio-xml.md) <br/> |直線セグメントの最後の頂点に対する x 座標または y 座標を格納します。  <br/> |
...
|**値**|**説明**|**詳細情報**|
|:-----|:-----|:-----|
|X  <br/> |直線セグメントの最後の頂点に対する x 座標です。  <br/> |[[LineTo] 行 ([Geometry] セクション)](lineto-row-geometry-section.md) <br/> |
|Y  <br/> |直線セグメントの最後の頂点に対する y 座標です。  <br/> |[[LineTo] 行 ([Geometry] セクション)](lineto-row-geometry-section.md) <br/> |
