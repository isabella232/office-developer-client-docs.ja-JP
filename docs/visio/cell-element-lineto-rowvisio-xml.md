...
---
# <a name="cell-element-lineto-row-visio-xml"></a>セル要素 ([lineto] 行) ('Visio XML')

含まれている x のまたは直線の線分の終点の y 座標。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[行要素 (ジオメトリ)](row-element-geometry-sectionvisio-xml.md) <br/> |[LineTo_Type](lineto_type-complextypevisio-xml.md) <br/> |含まれている x のまたは直線の線分の終点の y 座標。  <br/> |
