...
---
# <a name="row-element-hyperlink-section-visio-xml"></a>Row 要素 (ハイパーリンクセクション) (Visio XML)

図形または図面ページと、別の図面ページ、別のファイル、または web サイトとの間に複数のジャンプを作成するための要素が含まれています。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |図形または図面ページと、別の図面ページ、別のファイル、または web サイトとの間に複数のジャンプを作成するための要素が含まれています。  <br/> |
   
### <a name="child-elements"></a>子要素

|**Element**|**型**|**説明**|
|:-----|:-----|:-----|
|[Cell](cell-element-hyperlink-rowvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |図形に関連付けられた単一のハイパーリンクの情報が含まれています。  <br/> |
