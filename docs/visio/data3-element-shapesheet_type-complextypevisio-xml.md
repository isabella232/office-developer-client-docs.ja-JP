...
---
# <a name="data3-element-shapesheettype-complextype-visio-xml"></a>Data3 要素 (ShapeSheet_Type complexType)'Visio XML (')
...
|||
|:-----|:-----|
|**要素の型** <br/> |[Data_Type](data_type-complextypevisio-xml.md) <br/> |
