...
ms.locfileid: "59607858"
---
# <a name="rel-element-page_type-complextype-visio-xml"></a>Rel 要素 (Page_Type complexType) (Visio XML)

対応するページ XML を持つパーツとの関係を指定します。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[Page](page-element-pages_type-complextypevisio-xml.md) <br/> |[Page_Type](page_type-complextypevisio-xml.md) <br/> |図面に格納されているページ XML のインスタンスを 1 つ指定します。  <br/> |
