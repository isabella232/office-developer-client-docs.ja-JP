...
対応するページ XML を持つパーツへのリレーションシップを指定します。
...
|**要素**|**型**|**説明**|
|:-----|:-----|:-----|
|[Page](page-element-pages_type-complextypevisio-xml.md) <br/> |[Page_Type](page_type-complextypevisio-xml.md) <br/> |図面に格納されているページ XML の1つのインスタンスを指定します。  <br/> |
