...
事前定義された単純な影と斜体の影の一覧を参照してください**スタイル**] ボックスの一覧で、[**ページ設定**] ダイアログ ボックスの [**影**] タブ ([**デザイン**] タブで、矢印をクリック、 **[ページ設定**)。 
  
別の数式または**CellsU**プロパティを使用したプログラムから、名前によって [shdwtype] セルへの参照を取得、次のように使用します。 
