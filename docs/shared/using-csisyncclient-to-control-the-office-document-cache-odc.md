...
2 者間通信用のコンシューマーの COM オブジェクトを識別します。 最大 39 文字の空でない必要があります。 ProgIDs の詳細については、「Key」を参照してください。 [ \<ProgID\> ](https://docs.microsoft.com/windows/desktop/com/-progid--key) 
